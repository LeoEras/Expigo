...
<head>
	...
	<?php $listcssjs = array(
			...
			'catalog/view/theme/'.$config->get($config->get('config_theme') . '_directory').'/css/notification.css',
...
?>
    ...
    <?php $listcssjs = array(
			...
			'catalog/view/theme/'.$config->get($config->get('config_theme') . '_directory').'/js/jquery.jcarousel.min.js'
    ); ?>
							...
							<div class="megamenu-pattern">
								<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12" style="padding-left: 0px; padding-right: 0px;">
										<div class="menu-holder">
											<ul class="megamenu menuexpigo">
												<li class="with-sub-menu hover">
													<a href="http://expigo.com/ecommerce/index.php?route=information/information&information_id=7" class="menulinks">
														<span><strong>
														OUR History
														<span class="iconmenu"><img src="http://expigo.com/ecommerce/image/catalog/history_icon.png"></span>
														</strong></span>
													</a>
												</li>
												<li class="with-sub-menu hover">
													<a href="#" class="menulinks">
														<span><strong>
														OUR Products
														<span class="iconmenu"><img src="http://expigo.com/ecommerce/image/catalog/coffe.png"></span>
														</strong></span>
													</a>
												</li>
												<li class="with-sub-menu hover">
													<a href="http://expigo.com/ecommerce/index.php?route=information/information&information_id=8" class="menulinks">
														<span><strong>
														coffee process 
														<span class="iconmenu"><img src="http://expigo.com/ecommerce/image/catalog/coffeebeans.png"></span>
														</strong></span>
													</a>
												</li>
												<li class="with-sub-menu hover">
													<a href="http://expigo.com/ecommerce/index.php?route=information/contact" class="menulinks">
														<span><strong>
														Contact Us
														<span class="iconmenu"><img src="http://expigo.com/ecommerce/image/catalog/contact.png"></span>
														</strong></span>
													</a>
												</li>
