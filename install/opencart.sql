...
-- 
-- Servidor: custsqlmoo20
-- Tiempo de generación: 21-08-2016 a las 13:43:15
-- Versión del servidor: 5.5.46
-- Versión de PHP: 4.4.9
-- 
-- Base de datos: `expigo_e`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_address`
-- 

INSERT INTO `oc_address` VALUES (1, 1, 'Yamil', 'Nuñez', 'Skysite', 'juan tanca', '', 'guayaquil', 'ec091191', 62, 988, '');
INSERT INTO `oc_address` VALUES (2, 2, 'Yamil', 'Nuñez', '', 'Juan tanca', '', 'Guayaquil', '12344321', 62, 988, '');
INSERT INTO `oc_address` VALUES (3, 3, 'Jhon', 'Barreiro', '', 'La Joya, Zafiro', '', 'Guayaquil', '341341', 62, 988, '');
INSERT INTO `oc_address` VALUES (4, 4, 'Leonardo', 'Eras', '', 'Guayacanes Mz 123 V1', '', 'Guayaquil', '', 62, 988, '');
INSERT INTO `oc_address` VALUES (5, 5, 'juanito', 'alimaña', 'dadasas', 'qeqwwwqe', '', '|1312312123', 'ad12321', 62, 983, '');
INSERT INTO `oc_address` VALUES (6, 6, 'andres', 'caceres', '131231', '1231eqweqweqweq', '', '12312312312312312', '1231231232', 62, 994, '');
INSERT INTO `oc_address` VALUES (7, 7, 'Leonardo', 'Eras', '', 'DSSSSAS', '', 'SDASDADAD', 'dsadsaee22', 62, 988, '');
INSERT INTO `oc_address` VALUES (8, 8, 'abraham', 'aguirre', '', 'juan tanca', '', 'guayaquil', '12344321', 62, 988, '');
INSERT INTO `oc_address` VALUES (9, 9, 'Fernando', 'Campaña', '', 'Alborada etapa 3 mz 1', '', 'Guayaquil', '2113', 62, 988, '');
INSERT INTO `oc_address` VALUES (10, 10, 'Leonardo', 'Eras', '', 'Guayacanes Mz 124 V1', '', 'Guayaquil', '', 62, 988, '');
INSERT INTO `oc_address` VALUES (11, 11, 'Pepe', 'Lucho', '', 'Guasmito1', '', 'Guayaquil', '3244', 62, 988, '');

-- --------------------------------------------------------

-- 
-- Estructura de tabla para la tabla `oc_affiliate`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_affiliate`
-- 
...
-- 
-- Estructura de tabla para la tabla `oc_affiliate_activity`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_affiliate_activity`
-- 
...
-- 
-- Estructura de tabla para la tabla `oc_affiliate_login`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_affiliate_login`
-- 
...
-- 
-- Estructura de tabla para la tabla `oc_affiliate_transaction`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_affiliate_transaction`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_api`
-- 

INSERT INTO `oc_api` VALUES (1, 'Default', '', 1, '2016-06-07 16:30:32', '2016-06-07 16:30:32');
...
-- 
-- Volcar la base de datos para la tabla `oc_api_ip`
-- 

INSERT INTO `oc_api_ip` VALUES (1, 1, '192.188.59.84');
INSERT INTO `oc_api_ip` VALUES (2, 1, '200.9.176.9');
INSERT INTO `oc_api_ip` VALUES (3, 1, '186.101.235.61');
INSERT INTO `oc_api_ip` VALUES (4, 1, '181.39.215.101');
INSERT INTO `oc_api_ip` VALUES (5, 1, '186.66.33.238');
INSERT INTO `oc_api_ip` VALUES (6, 1, '200.126.13.131');
...
-- 
-- Volcar la base de datos para la tabla `oc_api_session`
-- 

INSERT INTO `oc_api_session` VALUES (15, 1, '8OzXFFTCRwtJQ7LB7RCOk1oTnV0h8mPA', 'a43bb7c99dbe3ec0cfd27da9c7c54f0e', 'temp_session_57b679da379c3', '186.66.33.238', '2016-08-18 23:15:38', '2016-08-18 23:15:38');
INSERT INTO `oc_api_session` VALUES (14, 1, '4ZMfgdTiuoRxmHKgMvjSjCeXZfUBbG2H', 'a43bb7c99dbe3ec0cfd27da9c7c54f0e', 'temp_session_57b679d06e1da', '186.66.33.238', '2016-08-18 23:15:28', '2016-08-18 23:15:28');
INSERT INTO `oc_api_session` VALUES (13, 1, 'XQcdWQlJ9vnGIXEbnhWhFUJaVqkm0iAN', 'a43bb7c99dbe3ec0cfd27da9c7c54f0e', 'temp_session_57b679b125b4e', '186.66.33.238', '2016-08-18 23:14:57', '2016-08-18 23:14:57');
INSERT INTO `oc_api_session` VALUES (12, 1, 'oxVSLbNN67SVb12UzfJaUNyFrAb3Es49', 'a43bb7c99dbe3ec0cfd27da9c7c54f0e', 'temp_session_57b679a75a2ec', '186.66.33.238', '2016-08-18 23:14:47', '2016-08-18 23:14:47');
INSERT INTO `oc_api_session` VALUES (11, 1, '0oCdkhoumEh4GR49lCtgCG6IKb2uOjtq', 'a43bb7c99dbe3ec0cfd27da9c7c54f0e', 'temp_session_57b6799935c56', '186.66.33.238', '2016-08-18 23:14:33', '2016-08-18 23:14:33');
INSERT INTO `oc_api_session` VALUES (10, 1, 'zbOiBaZyZcLZs7QNmSwapkd0dmZgnLoE', '1af7453091b5ba6cf86a885bf5970def', 'temp_session_57a8f384ca6e6', '200.126.13.131', '2016-08-08 17:03:00', '2016-08-08 17:03:00');
INSERT INTO `oc_api_session` VALUES (9, 1, 'RYdQfmh5tCv1AiYbU5fAqP0DbTBXyPSD', '1af7453091b5ba6cf86a885bf5970def', 'temp_session_57a8f37899c3d', '200.126.13.131', '2016-08-08 17:02:48', '2016-08-08 17:02:51');
INSERT INTO `oc_api_session` VALUES (16, 1, 'jBGwuF3QOZhmI9jNlOH1gSWVGwVjYYu2', 'a43bb7c99dbe3ec0cfd27da9c7c54f0e', 'temp_session_57b679e04e993', '186.66.33.238', '2016-08-18 23:15:44', '2016-08-18 23:15:44');
INSERT INTO `oc_api_session` VALUES (17, 1, 'JUEXHu74MFhPK6VFJTQmTsHr5iRJpRPM', 'a43bb7c99dbe3ec0cfd27da9c7c54f0e', 'temp_session_57b67a080909f', '186.66.33.238', '2016-08-18 23:16:24', '2016-08-18 23:16:24');
INSERT INTO `oc_api_session` VALUES (18, 1, '385WtT1xstnCkjqgiUJKns0Jcw7kaZ6P', 'a43bb7c99dbe3ec0cfd27da9c7c54f0e', 'temp_session_57b67a0c2dd6b', '186.66.33.238', '2016-08-18 23:16:28', '2016-08-18 23:16:28');
INSERT INTO `oc_api_session` VALUES (19, 1, '91gIq72Y9wc0mi6lCeCLCuhxQfiuENWN', 'a43bb7c99dbe3ec0cfd27da9c7c54f0e', 'temp_session_57b67a1f7b9a7', '186.66.33.238', '2016-08-18 23:16:47', '2016-08-18 23:16:47');
INSERT INTO `oc_api_session` VALUES (20, 1, 'KHzbi4kuHAfrTzxdA49bUGzaBVlFlf34', 'a43bb7c99dbe3ec0cfd27da9c7c54f0e', 'temp_session_57b67a2faf054', '186.66.33.238', '2016-08-18 23:17:03', '2016-08-18 23:17:03');
INSERT INTO `oc_api_session` VALUES (21, 1, 'rwprdKNuFMPdr3E4oTM671E5ZnSOBNO0', 'a43bb7c99dbe3ec0cfd27da9c7c54f0e', 'temp_session_57b67a40ae133', '186.66.33.238', '2016-08-18 23:17:20', '2016-08-18 23:17:20');
INSERT INTO `oc_api_session` VALUES (22, 1, '9xwghDYfXeMtKqxGSfbRNESG4sFJedwa', 'a43bb7c99dbe3ec0cfd27da9c7c54f0e', 'temp_session_57b67a42769a3', '186.66.33.238', '2016-08-18 23:17:22', '2016-08-18 23:17:22');
INSERT INTO `oc_api_session` VALUES (23, 1, 'nWuqCEAaydWldSyLqLZomQCLBdiJzt38', 'a43bb7c99dbe3ec0cfd27da9c7c54f0e', 'temp_session_57b67a47167fb', '186.66.33.238', '2016-08-18 23:17:27', '2016-08-18 23:17:27');
INSERT INTO `oc_api_session` VALUES (24, 1, '4UPpemIwKSxzdFSDt0frHgLPnjZhE5Ow', 'a43bb7c99dbe3ec0cfd27da9c7c54f0e', 'temp_session_57b67a4f67e00', '186.66.33.238', '2016-08-18 23:17:35', '2016-08-18 23:17:35');
INSERT INTO `oc_api_session` VALUES (25, 1, '16LN47ZlWXnPhhrVQFm2Ah6Iv1vWbgCI', 'a43bb7c99dbe3ec0cfd27da9c7c54f0e', 'temp_session_57b67a5481677', '186.66.33.238', '2016-08-18 23:17:40', '2016-08-18 23:17:40');
INSERT INTO `oc_api_session` VALUES (26, 1, 'g0A3TpaYnyR0GRogew3IS98B6DRSCTce', 'a43bb7c99dbe3ec0cfd27da9c7c54f0e', 'temp_session_57b67a5877307', '186.66.33.238', '2016-08-18 23:17:44', '2016-08-18 23:17:44');
INSERT INTO `oc_api_session` VALUES (27, 1, '7ouOpHeyJwzCbBt36LUEzT9rCykbLzrV', 'a43bb7c99dbe3ec0cfd27da9c7c54f0e', 'temp_session_57b67a5c2cc16', '186.66.33.238', '2016-08-18 23:17:48', '2016-08-18 23:17:48');
INSERT INTO `oc_api_session` VALUES (28, 1, '0cDn6XNEhVaVHDMBe4I9WnvEV4fKawBi', 'a43bb7c99dbe3ec0cfd27da9c7c54f0e', 'temp_session_57b67a601a2a1', '186.66.33.238', '2016-08-18 23:17:52', '2016-08-18 23:17:52');
INSERT INTO `oc_api_session` VALUES (29, 1, 'n8P7AUv7jB7YXJJw24JwxZZnpE7Ns6Jo', 'a43bb7c99dbe3ec0cfd27da9c7c54f0e', 'temp_session_57b67a69c25b7', '186.66.33.238', '2016-08-18 23:18:01', '2016-08-18 23:18:01');
INSERT INTO `oc_api_session` VALUES (30, 1, 'gyES7IBE701A1iWYW53xKZydgOz7Zo90', 'a43bb7c99dbe3ec0cfd27da9c7c54f0e', 'temp_session_57b67a6ecbc98', '186.66.33.238', '2016-08-18 23:18:06', '2016-08-18 23:18:06');
INSERT INTO `oc_api_session` VALUES (31, 1, 'Q0hwxNlfKWwAOsBOpjxH0ZxXTJebiysk', 'a43bb7c99dbe3ec0cfd27da9c7c54f0e', 'temp_session_57b67a7333d3d', '186.66.33.238', '2016-08-18 23:18:11', '2016-08-18 23:18:11');
INSERT INTO `oc_api_session` VALUES (32, 1, 'yPcUMaijGJgpOJsYCVqsVywi0YFga2C4', 'a43bb7c99dbe3ec0cfd27da9c7c54f0e', 'temp_session_57b67a75e18e4', '186.66.33.238', '2016-08-18 23:18:13', '2016-08-18 23:18:13');
INSERT INTO `oc_api_session` VALUES (33, 1, 'i2AFtUXobMsRz2uRuRBCHUNoPUKBSQ7z', 'a43bb7c99dbe3ec0cfd27da9c7c54f0e', 'temp_session_57b67a785ae23', '186.66.33.238', '2016-08-18 23:18:16', '2016-08-18 23:18:16');
INSERT INTO `oc_api_session` VALUES (34, 1, '0ZRspkXjBQkI3dN2QMbuzzq6CezGTBXE', 'a43bb7c99dbe3ec0cfd27da9c7c54f0e', 'temp_session_57b67a7e10fd7', '186.66.33.238', '2016-08-18 23:18:22', '2016-08-18 23:18:22');
INSERT INTO `oc_api_session` VALUES (35, 1, '3j9SBkKCk8SOwZuflLmA6D2RsoTdryfR', 'a43bb7c99dbe3ec0cfd27da9c7c54f0e', 'temp_session_57b67a83d6b8e', '186.66.33.238', '2016-08-18 23:18:27', '2016-08-18 23:18:27');
INSERT INTO `oc_api_session` VALUES (36, 1, 'XeETdbAR3spY6FbHVaD7d2SyfgMxPVWT', 'a43bb7c99dbe3ec0cfd27da9c7c54f0e', 'temp_session_57b67a86c9fbb', '186.66.33.238', '2016-08-18 23:18:30', '2016-08-18 23:18:30');
...
-- 
-- Volcar la base de datos para la tabla `oc_attribute`
-- 

INSERT INTO `oc_attribute` VALUES (3, 6, 1);
...
-- 
-- Volcar la base de datos para la tabla `oc_attribute_description`
-- 

INSERT INTO `oc_attribute_description` VALUES (3, 2, 'AROMA-FRAGANCIA');
INSERT INTO `oc_attribute_description` VALUES (3, 1, 'AROMA-FRAGANCIA');
...
-- 
-- Volcar la base de datos para la tabla `oc_attribute_group`
-- 

INSERT INTO `oc_attribute_group` VALUES (6, 1);
...
-- 
-- Volcar la base de datos para la tabla `oc_attribute_group_description`
-- 

INSERT INTO `oc_attribute_group_description` VALUES (6, 2, 'ORGANOLEPTICAS');
INSERT INTO `oc_attribute_group_description` VALUES (6, 1, 'ORGANOLEPTICAS');
...
-- 
-- Volcar la base de datos para la tabla `oc_banner`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_banner_image`
-- 
...
-- 
-- Estructura de tabla para la tabla `oc_banner_image_description`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_banner_image_description`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_cart`
-- 

INSERT INTO `oc_cart` VALUES (28, 7, 'e659dd2182d6afbe70c0457eb560a66c', 56, 0, '[]', 1, '2016-07-19 16:30:15');
INSERT INTO `oc_cart` VALUES (36, 8, '96ced20ae1c836ba07f990f5eac7f7c2', 57, 0, '[]', 1, '2016-07-26 16:09:58');
INSERT INTO `oc_cart` VALUES (45, 1, '8077e94ae5bc46c34c503ceaf0fbb913', 56, 0, '[]', 1, '2016-08-16 13:48:33');
...
-- 
-- Volcar la base de datos para la tabla `oc_category`
-- 

INSERT INTO `oc_category` VALUES (61, '', 0, 0, 1, 0, 1, '2016-06-20 11:38:43', '2016-06-21 13:36:10');
INSERT INTO `oc_category` VALUES (62, '', 0, 0, 1, 0, 1, '2016-06-20 11:39:01', '2016-06-20 11:39:01');
INSERT INTO `oc_category` VALUES (60, '', 0, 0, 1, 0, 1, '2016-06-20 11:38:13', '2016-06-21 13:34:41');
INSERT INTO `oc_category` VALUES (59, '', 0, 0, 1, 0, 1, '2016-06-20 10:48:46', '2016-06-21 13:34:53');
...
-- 
-- Volcar la base de datos para la tabla `oc_category_description`
-- 

INSERT INTO `oc_category_description` VALUES (59, 1, 'Expigo Vilcabamba Coffee', '', 'vilcabamba', 'coffee vilcabamba', 'coffee vilcabamba expigo');
INSERT INTO `oc_category_description` VALUES (60, 1, 'Expigo Galápagos Coffee', '', 'galápagos coffe expigo', 'Expigo Galápagos Coffee', 'Expigo Galápagos Coffee');
INSERT INTO `oc_category_description` VALUES (62, 1, 'Expigo House Blend Coffee', '', 'Expigo House Blend Coffee', 'Expigo House Blend Coffee', 'Expigo House Blend Coffee');
INSERT INTO `oc_category_description` VALUES (61, 1, 'Expigo Zaruma Coffee', '&lt;p&gt;&lt;br&gt;&lt;/p&gt;', 'Expigo Zaruma Coffee', 'Expigo Zaruma Coffee', 'Expigo Zaruma Coffee');
INSERT INTO `oc_category_description` VALUES (59, 2, 'Expigo Vilcabamba Coffee', '', 'vilcabamba', 'coffee vilcabamba', 'coffee vilcabamba expigo');
INSERT INTO `oc_category_description` VALUES (60, 2, 'Expigo Galápagos Coffee', '', 'galápagos coffe expigo', 'Expigo Galápagos Coffee', 'Expigo Galápagos Coffee');
INSERT INTO `oc_category_description` VALUES (62, 2, 'Expigo House Blend Coffee', '', 'Expigo House Blend Coffee', 'Expigo House Blend Coffee', 'Expigo House Blend Coffee');
INSERT INTO `oc_category_description` VALUES (61, 2, 'Expigo Zaruma Coffee', '&lt;p&gt;&lt;br&gt;&lt;/p&gt;', 'Expigo Zaruma Coffee', 'Expigo Zaruma Coffee', 'Expigo Zaruma Coffee');
...
-- 
-- Volcar la base de datos para la tabla `oc_category_filter`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_category_path`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_category_to_layout`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_category_to_store`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_country`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_coupon`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_coupon_category`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_coupon_history`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_coupon_product`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_currency`
-- 

INSERT INTO `oc_currency` VALUES (1, 'Pound Sterling', 'GBP', '£', '', '2', 0.76480001, 1, '2016-08-21 00:02:57');
INSERT INTO `oc_currency` VALUES (2, 'US Dollar', 'USD', '$', '', '2', 1.00000000, 1, '2016-08-21 13:32:56');
INSERT INTO `oc_currency` VALUES (3, 'Euro', 'EUR', '', '€', '2', 0.88249999, 1, '2016-08-21 00:02:57');
...
-- 
-- Volcar la base de datos para la tabla `oc_custom_field`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_custom_field_customer_group`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_custom_field_description`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_custom_field_value`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_custom_field_value_description`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_customer`
-- 

INSERT INTO `oc_customer` VALUES (1, 1, 0, 'Yamil', 'Nuñez', 'yamil.nunez@gmail.com', '0995951600', '', '4cb4590e26b4f54c8858cd7f7a055de16369e7a3', '8qTrIGnsj', NULL, NULL, 0, 1, '', '186.101.235.61', 1, 1, 0, '', 'zXbyqCPBqfazrzmLc7zCuI78yHBaeWVDEwYygeJm', '2016-06-07 16:54:10');
INSERT INTO `oc_customer` VALUES (2, 1, 0, 'Yamil', 'Nuñez', 'yamil@skysite.com.ec', '0995951600', '', 'e2148eb7f6f0ccc568188d99abb63712604457e4', 'd1Ls9B6v1', NULL, NULL, 1, 2, '', '200.9.176.9', 1, 1, 0, '', '', '2016-06-13 16:20:00');
INSERT INTO `oc_customer` VALUES (3, 1, 0, 'Jhon', 'Barreiro', 'jjbarrei93@gmail.com', '0983890891', '', '61a05ff8ec7d6758305424811a13fccf40481d32', 'AnLvP64IF', NULL, NULL, 0, 3, '', '201.183.84.129', 1, 1, 0, '', '5vsIKK5ENOmc0wAublZeFB0qYI653jdLFZUhZSC7', '2016-06-21 21:28:16');
INSERT INTO `oc_customer` VALUES (4, 1, 0, 'Leonardo', 'Eras', 'leoded94@hotmail.com', '099123123', '1234', '4b8552859ebb9eddd87d99467c5723c2d8019e9d', 'pF6ONwTiZ', NULL, NULL, 0, 4, '', '192.188.59.84', 1, 1, 0, '', '', '2016-07-11 17:16:13');
INSERT INTO `oc_customer` VALUES (5, 1, 0, 'juanito', 'alimaña', 'juanito@gmail.com', 'dasd', 'das87das9d', 'b642d670781c6196c54aa7e4ba3b147c72a2713d', 'VgkFMDCJu', NULL, NULL, 0, 5, '', '200.126.13.140', 1, 1, 0, '', '', '2016-07-18 16:55:04');
INSERT INTO `oc_customer` VALUES (6, 1, 0, 'andres', 'caceres', 'ascacere92@gmail.com', 'dmdmmmdmdmmdmd', '12312312', '3ba05ccf63d09d182bce048f7b4f144fd8c28064', 'NCiHw30fG', NULL, NULL, 0, 6, '', '200.126.13.140', 1, 1, 0, '', '', '2016-07-18 17:07:38');
INSERT INTO `oc_customer` VALUES (7, 1, 0, 'Leonardo', 'Eras', 'leoded94@hotmails.com', '092315645', '1234', '29ac0e8490256a4288a011a1b9d18878b5654c34', '34lremupI', NULL, NULL, 0, 7, '', '200.126.13.131', 1, 1, 0, '', '', '2016-07-19 16:19:28');
INSERT INTO `oc_customer` VALUES (8, 1, 0, 'abraham', 'aguirre', 'ynunez@espol.edu.ec', '12344321', '', 'e4d64e68e4ca43e75a8067b5364b570e8e0aebe7', 'yjMjr8itb', NULL, NULL, 0, 8, '', '200.9.176.9', 1, 1, 0, '', '', '2016-07-25 19:48:29');
INSERT INTO `oc_customer` VALUES (9, 1, 0, 'Fernando', 'Campaña', 'fercamp09@gmail.com', '2233456', '', '522378d61ca7861f042e114c94100cc4e0b1f450', '34KgsM41R', NULL, NULL, 0, 9, '', '186.66.33.238', 1, 1, 0, '', '', '2016-07-31 21:18:52');
INSERT INTO `oc_customer` VALUES (10, 1, 0, 'Leonardo', 'Eras', 'leonardoeras30@gmail.com', '0986787173', '1234', '40fe7e57d07ee84120336bf21b95fc7a24bfaaba', '1mjIxMUsr', NULL, NULL, 0, 10, '', '190.155.164.230', 1, 1, 0, '', '', '2016-07-31 21:49:44');
INSERT INTO `oc_customer` VALUES (11, 1, 0, 'Pepe', 'Lucho', 'anrosant@espol.edu.ec', '1231', '', 'a69b7a9fab1f3f49e5dc14c99c151c242665a588', '5OyqrF7AD', NULL, NULL, 0, 11, '', '200.126.13.131', 1, 1, 0, '', '', '2016-08-01 13:44:07');
...
-- 
-- Volcar la base de datos para la tabla `oc_customer_activity`
-- 

INSERT INTO `oc_customer_activity` VALUES (1, 1, 'register', '{"customer_id":1,"name":"Yamil Nu\\u00f1ez"}', '200.9.176.9', '2016-06-07 16:54:10');
INSERT INTO `oc_customer_activity` VALUES (2, 1, 'order_account', '{"customer_id":"1","name":"Yamil Nu\\u00f1ez","order_id":1}', '200.9.176.9', '2016-06-07 16:54:35');
INSERT INTO `oc_customer_activity` VALUES (3, 0, 'order_guest', '{"name":"Yamil nunez","order_id":2}', '200.9.176.9', '2016-06-13 16:03:44');
INSERT INTO `oc_customer_activity` VALUES (4, 2, 'register', '{"customer_id":2,"name":"Yamil Nu\\u00f1ez"}', '200.9.176.9', '2016-06-13 16:20:00');
INSERT INTO `oc_customer_activity` VALUES (5, 2, 'login', '{"customer_id":"2","name":"Yamil Nu\\u00f1ez"}', '200.9.176.9', '2016-06-13 16:20:31');
INSERT INTO `oc_customer_activity` VALUES (6, 3, 'register', '{"customer_id":3,"name":"Jhon Barreiro"}', '201.183.84.129', '2016-06-21 21:28:16');
INSERT INTO `oc_customer_activity` VALUES (7, 3, 'order_account', '{"customer_id":"3","name":"Jhon Barreiro","order_id":3}', '201.183.84.129', '2016-06-21 21:28:53');
INSERT INTO `oc_customer_activity` VALUES (8, 4, 'register', '{"customer_id":4,"name":"Leonardo Eras"}', '192.188.59.84', '2016-07-11 17:16:14');
INSERT INTO `oc_customer_activity` VALUES (9, 5, 'register', '{"customer_id":5,"name":"juanito alima\\u00f1a"}', '200.126.13.140', '2016-07-18 16:55:04');
INSERT INTO `oc_customer_activity` VALUES (10, 5, 'login', '{"customer_id":"5","name":"juanito alima\\u00f1a"}', '200.126.13.140', '2016-07-18 16:56:46');
INSERT INTO `oc_customer_activity` VALUES (11, 5, 'order_account', '{"customer_id":"5","name":"juanito alima\\u00f1a","order_id":4}', '200.126.13.140', '2016-07-18 17:06:12');
INSERT INTO `oc_customer_activity` VALUES (12, 6, 'register', '{"customer_id":6,"name":"andres caceres"}', '200.126.13.140', '2016-07-18 17:07:38');
INSERT INTO `oc_customer_activity` VALUES (13, 6, 'order_account', '{"customer_id":"6","name":"andres caceres","order_id":5}', '200.126.13.140', '2016-07-18 17:08:33');
INSERT INTO `oc_customer_activity` VALUES (14, 7, 'register', '{"customer_id":7,"name":"Leonardo Eras"}', '200.126.13.131', '2016-07-19 16:19:29');
INSERT INTO `oc_customer_activity` VALUES (15, 3, 'forgotten', '{"customer_id":"3","name":"Jhon Barreiro"}', '181.39.215.101', '2016-07-24 21:14:45');
INSERT INTO `oc_customer_activity` VALUES (16, 3, 'reset', '{"customer_id":"3","name":"Jhon Barreiro"}', '181.39.215.101', '2016-07-24 21:16:33');
INSERT INTO `oc_customer_activity` VALUES (17, 1, 'forgotten', '{"customer_id":"1","name":"Yamil Nu\\u00f1ez"}', '181.113.138.180', '2016-07-25 19:44:44');
INSERT INTO `oc_customer_activity` VALUES (18, 1, 'reset', '{"customer_id":"1","name":"Yamil Nu\\u00f1ez"}', '181.113.138.180', '2016-07-25 19:45:23');
INSERT INTO `oc_customer_activity` VALUES (19, 1, 'reset', '{"customer_id":"1","name":"Yamil Nu\\u00f1ez"}', '181.113.138.180', '2016-07-25 19:46:28');
INSERT INTO `oc_customer_activity` VALUES (20, 8, 'register', '{"customer_id":8,"name":"abraham aguirre"}', '181.113.138.180', '2016-07-25 19:48:29');
INSERT INTO `oc_customer_activity` VALUES (21, 8, 'order_account', '{"customer_id":"8","name":"abraham aguirre","order_id":7}', '181.113.138.180', '2016-07-25 21:39:57');
INSERT INTO `oc_customer_activity` VALUES (22, 8, 'login', '{"customer_id":"8","name":"abraham aguirre"}', '200.9.176.9', '2016-07-26 16:09:57');
INSERT INTO `oc_customer_activity` VALUES (23, 9, 'register', '{"customer_id":9,"name":"Fernando Campa\\u00f1a"}', '186.66.33.238', '2016-07-31 21:18:52');
INSERT INTO `oc_customer_activity` VALUES (24, 9, 'order_account', '{"customer_id":"9","name":"Fernando Campa\\u00f1a","order_id":16}', '186.66.33.238', '2016-07-31 21:24:30');
INSERT INTO `oc_customer_activity` VALUES (25, 10, 'register', '{"customer_id":10,"name":"Leonardo Eras"}', '190.155.164.230', '2016-07-31 21:49:44');
INSERT INTO `oc_customer_activity` VALUES (26, 10, 'order_account', '{"customer_id":"10","name":"Leonardo Eras","order_id":17}', '190.155.164.230', '2016-07-31 21:51:25');
INSERT INTO `oc_customer_activity` VALUES (27, 11, 'register', '{"customer_id":11,"name":"Pepe Lucho"}', '200.9.176.9', '2016-08-01 13:44:07');
INSERT INTO `oc_customer_activity` VALUES (28, 11, 'order_account', '{"customer_id":"11","name":"Pepe Lucho","order_id":18}', '200.9.176.9', '2016-08-01 13:45:25');
INSERT INTO `oc_customer_activity` VALUES (29, 1, 'login', '{"customer_id":"1","name":"Yamil Nu\\u00f1ez"}', '186.101.235.61', '2016-08-16 13:48:32');
...
-- 
-- Volcar la base de datos para la tabla `oc_customer_group`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_customer_group_description`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_customer_history`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_customer_ip`
-- 

INSERT INTO `oc_customer_ip` VALUES (1, 1, '200.9.176.9', '2016-06-07 16:54:10');
INSERT INTO `oc_customer_ip` VALUES (2, 2, '200.9.176.9', '2016-06-13 16:20:01');
INSERT INTO `oc_customer_ip` VALUES (3, 3, '201.183.84.129', '2016-06-21 21:28:16');
INSERT INTO `oc_customer_ip` VALUES (4, 4, '192.188.59.84', '2016-07-11 17:16:14');
INSERT INTO `oc_customer_ip` VALUES (5, 5, '200.126.13.140', '2016-07-18 16:55:04');
INSERT INTO `oc_customer_ip` VALUES (6, 6, '200.126.13.140', '2016-07-18 17:07:38');
INSERT INTO `oc_customer_ip` VALUES (7, 7, '200.126.13.131', '2016-07-19 16:19:29');
INSERT INTO `oc_customer_ip` VALUES (8, 8, '181.113.138.180', '2016-07-25 19:48:30');
INSERT INTO `oc_customer_ip` VALUES (9, 8, '200.9.176.9', '2016-07-26 16:09:58');
INSERT INTO `oc_customer_ip` VALUES (10, 9, '186.66.33.238', '2016-07-31 21:18:52');
INSERT INTO `oc_customer_ip` VALUES (11, 10, '190.155.164.230', '2016-07-31 21:49:44');
INSERT INTO `oc_customer_ip` VALUES (12, 11, '200.9.176.9', '2016-08-01 13:44:07');
INSERT INTO `oc_customer_ip` VALUES (13, 1, '186.101.235.61', '2016-08-16 13:48:33');
...
-- 
-- Volcar la base de datos para la tabla `oc_customer_login`
-- 

INSERT INTO `oc_customer_login` VALUES (1, 'expigo', '192.188.59.84', 4, '2016-06-13 16:49:44', '2016-07-11 17:12:28');
INSERT INTO `oc_customer_login` VALUES (2, 'mvillavi@espol.', '200.9.176.9', 3, '2016-06-21 16:04:23', '2016-06-21 16:04:42');
INSERT INTO `oc_customer_login` VALUES (4, '', '200.126.13.133', 1, '2016-07-11 16:41:22', '2016-07-11 16:41:22');
INSERT INTO `oc_customer_login` VALUES (6, 'expigo', '200.126.13.139', 2, '2016-07-18 16:44:57', '2016-07-18 16:45:01');
INSERT INTO `oc_customer_login` VALUES (7, 'somebody@test.com', '200.126.13.140', 4, '2016-07-18 16:51:30', '2016-07-18 16:52:31');
INSERT INTO `oc_customer_login` VALUES (8, 'expigo', '200.126.13.137', 1, '2016-07-18 16:56:16', '2016-07-18 16:56:16');
INSERT INTO `oc_customer_login` VALUES (9, 'ad12321', '200.126.13.140', 1, '2016-07-18 16:56:29', '2016-07-18 16:56:29');
INSERT INTO `oc_customer_login` VALUES (10, 'ad12321@gmail.com', '200.126.13.140', 1, '2016-07-18 16:56:39', '2016-07-18 16:56:39');
INSERT INTO `oc_customer_login` VALUES (11, 'hola''); select * from tienda where 1=1; --', '200.126.13.140', 3, '2016-07-18 17:12:57', '2016-07-18 17:13:14');
INSERT INTO `oc_customer_login` VALUES (12, 'juanito@gmail.com', '200.126.13.140', 5, '2016-07-18 17:13:26', '2016-07-18 17:15:13');
INSERT INTO `oc_customer_login` VALUES (13, 'alicia''; select * from datos where nombre like ''%', '200.126.13.140', 1, '2016-07-18 17:16:40', '2016-07-18 17:16:40');
INSERT INTO `oc_customer_login` VALUES (14, 'alicia''; select * from datos where nombre like ''%''', '200.126.13.140', 5, '2016-07-18 17:16:48', '2016-07-18 17:16:51');
INSERT INTO `oc_customer_login` VALUES (15, 'leoded94@hotmail.com', '200.126.13.131', 2, '2016-07-19 16:18:20', '2016-07-19 16:18:28');
INSERT INTO `oc_customer_login` VALUES (16, 'jjbarrei@espol.edu.ec', '181.39.215.101', 1, '2016-07-24 21:14:06', '2016-07-24 21:14:06');
INSERT INTO `oc_customer_login` VALUES (17, 'jjbarrei93@gmail.com', '181.39.215.101', 5, '2016-07-24 21:14:17', '2016-07-24 21:16:54');
INSERT INTO `oc_customer_login` VALUES (18, 'ynunez', '181.113.138.180', 1, '2016-07-25 19:44:05', '2016-07-25 19:44:05');
INSERT INTO `oc_customer_login` VALUES (20, 'ynunez', '200.9.176.9', 1, '2016-07-26 16:09:38', '2016-07-26 16:09:38');
INSERT INTO `oc_customer_login` VALUES (21, 'jhon_ja93@outlook.com', '200.126.13.133', 3, '2016-08-08 16:46:52', '2016-08-08 16:47:03');
...
-- 
-- Volcar la base de datos para la tabla `oc_customer_online`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_customer_reward`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_customer_transaction`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_customer_wishlist`
-- 

INSERT INTO `oc_customer_wishlist` VALUES (2, 42, '2016-06-13 16:20:31');
...
-- 
-- Volcar la base de datos para la tabla `oc_download`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_download_description`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_event`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_extension`
-- 
...
INSERT INTO `oc_extension` VALUES (24, 'module', 'information');
INSERT INTO `oc_extension` VALUES (23, 'module', 'carousel');
...
INSERT INTO `oc_extension` VALUES (34, 'captcha', 'google_captcha');
INSERT INTO `oc_extension` VALUES (13, 'module', 'category');
INSERT INTO `oc_extension` VALUES (14, 'module', 'account');
INSERT INTO `oc_extension` VALUES (32, 'analytics', 'google_analytics');
INSERT INTO `oc_extension` VALUES (17, 'payment', 'free_checkout');
INSERT INTO `oc_extension` VALUES (22, 'module', 'tg_tglite_revolution_slider');
INSERT INTO `oc_extension` VALUES (20, 'theme', 'theme_default');
INSERT INTO `oc_extension` VALUES (21, 'module', 'tg_themegloballite_settings');
INSERT INTO `oc_extension` VALUES (25, 'module', 'latest');
INSERT INTO `oc_extension` VALUES (26, 'module', 'category');
INSERT INTO `oc_extension` VALUES (27, 'module', 'tg_tglite_filter_product');
INSERT INTO `oc_extension` VALUES (28, 'module', 'tg_themegloballite_megamenu');
INSERT INTO `oc_extension` VALUES (29, 'payment', 'pp_express');
INSERT INTO `oc_extension` VALUES (30, 'module', 'pp_button');
INSERT INTO `oc_extension` VALUES (31, 'payment', 'bank_transfer');
INSERT INTO `oc_extension` VALUES (35, 'module', 'html');
...
-- 
-- Volcar la base de datos para la tabla `oc_filter`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_filter_description`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_filter_group`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_filter_group_description`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_geo_zone`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_information`
-- 
...
INSERT INTO `oc_information` VALUES (7, 0, 1, 1);
...
-- 
-- Volcar la base de datos para la tabla `oc_information_description`
-- 
...
INSERT INTO `oc_information_description` VALUES (8, 1, 'Coffee process', '&lt;p&gt;Proceso&lt;/p&gt;', 'coffeprocess', 'Coffee process', 'Coffee');
...
INSERT INTO `oc_information_description` VALUES (8, 2, 'Coffee process', '&lt;p&gt;Proceso&lt;/p&gt;', 'coffeprocess', 'Coffee process', 'Coffee');
INSERT INTO `oc_information_description` VALUES (7, 2, 'Nuestra Historia', '&lt;h2&gt;The history begins in 1946&lt;br&gt;with Mr. José A. González,&lt;/h2&gt;&lt;p&gt;who started the production and development of arabic coffee in the high zones of the austral region of Ecuador, a region known fot its excellency of the best high quality coffee.&lt;/p&gt;&lt;p&gt;In 1968 he decide to expand the operation and started exporting directly as a producer and broker of high quality coffee.&lt;/p&gt;&lt;p&gt;In 1976, Mr José González together with his family, founded Exportadora e Importadora González C. Ltda. dedicated to the exportation of green coffee in its main qualities.&lt;/p&gt;&lt;p&gt;Having always as a priority the good care of the ecology and the environment, Procafe was founded for the development of special orgnanic coffees in certified farms, amoung wich is the one that produces the variety that is most proudly presented to the world&quot; &quot;Galapagos Coffee&quot;.&lt;/p&gt;&lt;div class=&quot;historiaContenido&quot;&gt;With the wish to satisfy the world''s market demands, Intercafe is now producing: roasted, semiroasted, instant coffee and private laveling.&lt;img src=&quot;http://expigo.com/ecommerce/image/catalog/banner-tall.jpg&quot; style=&quot;width: 856px; float: none;&quot;&gt;&lt;span style=&quot;line-height: 1.1;&quot;&gt;&lt;br&gt;&lt;/span&gt;&lt;h2 style=&quot;text-align: center;&quot;&gt;&lt;br&gt;&lt;/h2&gt;\r\n\r\n&lt;/div&gt;', 'history', 'Historia Expigo', 'Historia cafe Expigo');
INSERT INTO `oc_information_description` VALUES (7, 1, 'Our history', '&lt;div class=&quot;historiaContenido&quot;&gt;\r\n\r\n&lt;h2&gt;The history begins in 1946&lt;br&gt;with Mr. José A. González,&lt;/h2&gt;\r\n\r\n\r\n\r\n&lt;p&gt;who started the production and development of arabic coffee in the high zones of the austral region\r\n\r\nof Ecuador, a region known fot its excellency of the best high quality coffee.  &lt;/p&gt;\r\n\r\n\r\n\r\n&lt;p&gt;In 1968 he decide to expand the operation and started exporting directly as a producer and broker of high quality coffee.&lt;/p&gt;\r\n\r\n\r\n\r\n&lt;p&gt;In 1976, Mr José González together with his family, founded Exportadora e Importadora González C. Ltda. dedicated to the exportation of green coffee in its main qualities.&lt;/p&gt;\r\n\r\n\r\n\r\n&lt;p&gt;Having always as a priority the good care of the ecology and the environment, Procafe was founded for the development of special orgnanic coffees in certified farms, amoung wich is the one that produces the variety that is most proudly presented to the world&quot; &quot;Galapagos Coffee&quot;.&lt;/p&gt;\r\n\r\n\r\n\r\n&lt;p&gt;With the wish to satisfy the world''s market demands, Intercafe is now producing: roasted, semiroasted, instant coffee and private laveling.&lt;/p&gt;\r\n\r\n&lt;/div&gt;', 'history', 'Expigo history', 'History Expigo coffee');
...
-- 
-- Volcar la base de datos para la tabla `oc_information_to_layout`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_information_to_store`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_language`
-- 

INSERT INTO `oc_language` VALUES (1, 'English', 'en-gb', 'en_US.UTF-8,en_US,en-gb,english', 'gb.png', 'english', 2, 1);
INSERT INTO `oc_language` VALUES (2, 'Español', 'es-es', '', '', '', 1, 1);
...
-- 
-- Volcar la base de datos para la tabla `oc_layout`
-- 
...
) ENGINE=MyISAM AUTO_INCREMENT=107 DEFAULT CHARSET=utf8 AUTO_INCREMENT=107 ;

-- 
-- Volcar la base de datos para la tabla `oc_layout_module`
-- 

INSERT INTO `oc_layout_module` VALUES (100, 1, 'latest.34', 'content_top', 0);
INSERT INTO `oc_layout_module` VALUES (101, 3, 'latest.35', 'column_left', 2);
INSERT INTO `oc_layout_module` VALUES (102, 3, 'information', 'column_left', 4);
INSERT INTO `oc_layout_module` VALUES (103, 3, 'category', 'column_left', 0);
INSERT INTO `oc_layout_module` VALUES (104, 2, 'category', 'column_left', 0);
INSERT INTO `oc_layout_module` VALUES (105, 5, 'category', 'column_left', 0);
INSERT INTO `oc_layout_module` VALUES (106, 1, 'carousel.36', 'content_bottom', 0);
...
-- 
-- Volcar la base de datos para la tabla `oc_layout_route`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_length_class`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_length_class_description`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_location`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_manufacturer`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_manufacturer_to_store`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_marketing`
-- 
...
-- 
-- Estructura de tabla para la tabla `oc_modification`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_modification`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_module`
-- 

INSERT INTO `oc_module` VALUES (34, 'Home Page Content Top', 'latest', '{"name":"Home Page Content Top","limit":"10","width":"200","height":"200","status":"1"}');
INSERT INTO `oc_module` VALUES (35, 'Category Page Column Left', 'latest', '{"name":"Category Page Column Left","limit":"8","width":"60","height":"60","status":"1"}');
INSERT INTO `oc_module` VALUES (36, 'Home Page Content Bottom', 'carousel', '{"name":"Home Page Content Bottom","banner_id":"8","width":"100","height":"100","status":"1"}');
INSERT INTO `oc_module` VALUES (37, 'Our Products', 'latest', '{"name":"Our Products","limit":"5","width":"200","height":"200","status":"0"}');
...
-- 
-- Volcar la base de datos para la tabla `oc_option`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_option_description`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_option_value`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_option_value_description`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_order`
-- 

INSERT INTO `oc_order` VALUES (1, 0, 'INV-2013-00', 0, 'Your Store', 'http://expigo.com/ecommerce/', 1, 1, 'Yamil', 'Nuñez', 'yamil.nunez@gmail.com', '0995951600', '', '', 'Yamil', 'Nuñez', 'Skysite', 'juan tanca', '', 'guayaquil', 'ec091191', 'Ecuador', 62, 'Guayas', 988, '', '[]', 'Cash On Delivery', 'cod', 'Yamil', 'Nuñez', 'Skysite', 'juan tanca', '', 'guayaquil', 'ec091191', 'Ecuador', 62, 'Guayas', 988, '', '[]', 'Flat Shipping Rate', 'flat.flat', '', 106.0000, 1, 0, 0.0000, 0, '', 1, 2, 'USD', 1.00000000, '200.9.176.9', '', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/50.0.2661.102 Safari/537.36', 'es-ES,es;q=0.8,en;q=0.6,pt;q=0.4', '2016-06-07 16:54:31', '2016-06-07 16:54:34');
INSERT INTO `oc_order` VALUES (2, 1, 'INV-2013-00', 0, 'Your Store', 'http://expigo.com/ecommerce/', 0, 1, 'Yamil', 'nunez', 'yamil.nunez@gmail.com', '12344231', '', '[]', 'Yamil', 'nunez', '', 'guayaquil', '', 'Guayaquil', '12344321', 'Ecuador', 62, 'Guayas', 988, '', '[]', 'Cash On Delivery', 'cod', 'Yamil', 'nunez', '', 'guayaquil', '', 'Guayaquil', '12344321', 'Ecuador', 62, 'Guayas', 988, '', '[]', 'Flat Shipping Rate', 'flat.flat', 'Prueba', 105.0000, 1, 0, 0.0000, 0, '', 1, 2, 'USD', 1.00000000, '200.9.176.9', '', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/51.0.2704.84 Safari/537.36', 'es-ES,es;q=0.8,en;q=0.6,pt;q=0.4', '2016-06-13 16:03:40', '2016-06-13 16:03:43');
INSERT INTO `oc_order` VALUES (3, 0, 'INV-2013-00', 0, 'Expigo', 'http://expigo.com/ecommerce/', 3, 1, 'Jhon', 'Barreiro', 'jjbarrei93@gmail.com', '0983890891', '', '', 'Jhon', 'Barreiro', '', 'La Joya, Zafiro', '', 'Guayaquil', '341341', 'Ecuador', 62, 'Guayas', 988, '', '[]', 'Cash On Delivery', 'cod', 'Jhon', 'Barreiro', '', 'La Joya, Zafiro', '', 'Guayaquil', '341341', 'Ecuador', 62, 'Guayas', 988, '', '[]', 'Flat Shipping Rate', 'flat.flat', 'Que venga envuelto por favor.', 218.2000, 1, 0, 0.0000, 0, '', 1, 2, 'USD', 1.00000000, '201.183.84.129', '', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_5) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/51.0.2704.84 Safari/537.36', 'en-US,en;q=0.8,es;q=0.6', '2016-06-21 21:28:47', '2016-06-21 21:28:52');
INSERT INTO `oc_order` VALUES (4, 0, 'INV-2016-00', 0, 'Expigo', 'http://expigo.com/ecommerce/', 5, 1, 'juanito', 'alimaña', 'juanito@gmail.com', 'dasd', 'das87das9d', '', 'juanito', 'alimaña', 'dadasas', 'qeqwwwqe', '', '|1312312123', 'ad12321', 'Ecuador', 62, 'Chimborazo', 983, '', '[]', 'Cash On Delivery', 'cod', 'juanito', 'alimaña', 'dadasas', 'qeqwwwqe', '', '|1312312123', 'ad12321', 'Ecuador', 62, 'Chimborazo', 983, '', '[]', 'Flat Shipping Rate', 'flat.flat', '', 59.1900, 1, 0, 0.0000, 0, '', 1, 2, 'USD', 1.00000000, '200.126.13.140', '', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/52.0.2743.75 Safari/537.36', 'es-ES,es;q=0.8', '2016-07-18 17:06:08', '2016-07-18 17:06:12');
INSERT INTO `oc_order` VALUES (5, 0, 'INV-2016-00', 0, 'Expigo', 'http://expigo.com/ecommerce/', 6, 1, 'andres', 'caceres', 'ascacere92@gmail.com', 'dmdmmmdmdmmdmd', '12312312', '', 'andres', 'caceres', '131231', '1231eqweqweqweq', '', '12312312312312312', '1231231232', 'Ecuador', 62, 'Napo', 994, '', '[]', 'Cash On Delivery', 'cod', 'andres', 'caceres', '131231', '1231eqweqweqweq', '', '12312312312312312', '1231231232', 'Ecuador', 62, 'Napo', 994, '', '[]', 'Flat Shipping Rate', 'flat.flat', '', 35.6500, 1, 0, 0.0000, 0, '', 1, 2, 'USD', 1.00000000, '200.126.13.140', '', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/52.0.2743.75 Safari/537.36', 'es-ES,es;q=0.8', '2016-07-18 17:08:31', '2016-07-18 17:08:33');
INSERT INTO `oc_order` VALUES (6, 0, 'INV-2016-00', 0, 'Expigo', 'http://expigo.com/ecommerce/', 8, 1, 'abraham', 'aguirre', 'ynunez@espol.edu.ec', '12344321', '', '', 'abraham', 'aguirre', '', 'juan tanca', '', 'guayaquil', '12344321', 'Ecuador', 62, 'Guayas', 988, '', '[]', 'PayPal Express Checkout', 'pp_express', 'abraham', 'aguirre', '', 'juan tanca', '', 'guayaquil', '12344321', 'Ecuador', 62, 'Guayas', 988, '', '[]', 'Flat Shipping Rate', 'flat.flat', '', 8.6000, 0, 0, 0.0000, 0, '', 1, 2, 'USD', 1.00000000, '181.113.138.180', '', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/51.0.2704.103 Safari/537.36', 'es-ES,es;q=0.8,en;q=0.6,pt;q=0.4,gl;q=0.2', '2016-07-25 21:38:34', '2016-07-25 21:38:34');
INSERT INTO `oc_order` VALUES (7, 0, 'INV-2016-00', 0, 'Expigo', 'http://expigo.com/ecommerce/', 8, 1, 'abraham', 'aguirre', 'ynunez@espol.edu.ec', '12344321', '', '', 'abraham', 'aguirre', '', 'juan tanca', '', 'guayaquil', '12344321', 'Ecuador', 62, 'Guayas', 988, '', '[]', 'Bank Transfer', 'bank_transfer', 'abraham', 'aguirre', '', 'juan tanca', '', 'guayaquil', '12344321', 'Ecuador', 62, 'Guayas', 988, '', '[]', 'Flat Shipping Rate', 'flat.flat', '', 8.6000, 7, 0, 0.0000, 0, '', 1, 2, 'USD', 1.00000000, '181.113.138.180', '', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/51.0.2704.103 Safari/537.36', 'es-ES,es;q=0.8,en;q=0.6,pt;q=0.4,gl;q=0.2', '2016-07-25 21:39:45', '2016-07-25 21:39:56');
INSERT INTO `oc_order` VALUES (8, 0, 'INV-2016-00', 0, 'Expigo', 'http://expigo.com/ecommerce/', 8, 1, 'abraham', 'aguirre', 'ynunez@espol.edu.ec', '12344321', '', '', 'abraham', 'aguirre', '', 'juan tanca', '', 'guayaquil', '12344321', 'Ecuador', 62, 'Guayas', 988, '', '[]', 'PayPal Express Checkout', 'pp_express', 'abraham', 'aguirre', '', 'juan tanca', '', 'guayaquil', '12344321', 'Ecuador', 62, 'Guayas', 988, '', '[]', 'Flat Shipping Rate', 'flat.flat', '', 21.8000, 0, 0, 0.0000, 0, '', 1, 2, 'USD', 1.00000000, '200.9.176.9', '', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/51.0.2704.103 Safari/537.36', 'es-ES,es;q=0.8,en;q=0.6,pt;q=0.4,gl;q=0.2', '2016-07-26 16:10:15', '2016-07-26 16:10:15');
INSERT INTO `oc_order` VALUES (9, 0, 'INV-2016-00', 0, 'Expigo', 'http://expigo.com/ecommerce/', 8, 1, 'abraham', 'aguirre', 'ynunez@espol.edu.ec', '12344321', '', '', 'abraham', 'aguirre', '', 'juan tanca', '', 'guayaquil', '12344321', 'Ecuador', 62, 'Guayas', 988, '', '[]', 'PayPal Express Checkout', 'pp_express', 'abraham', 'aguirre', '', 'juan tanca', '', 'guayaquil', '12344321', 'Ecuador', 62, 'Guayas', 988, '', '[]', 'Flat Shipping Rate', 'flat.flat', '', 21.8000, 0, 0, 0.0000, 0, '', 1, 2, 'USD', 1.00000000, '200.9.176.9', '', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/51.0.2704.103 Safari/537.36', 'es-ES,es;q=0.8,en;q=0.6,pt;q=0.4,gl;q=0.2', '2016-07-26 16:18:46', '2016-07-26 16:18:46');
INSERT INTO `oc_order` VALUES (10, 0, 'INV-2016-00', 0, 'Expigo', 'http://expigo.com/ecommerce/', 8, 1, 'abraham', 'aguirre', 'ynunez@espol.edu.ec', '12344321', '', '', 'abraham', 'aguirre', '', 'juan tanca', '', 'guayaquil', '12344321', 'Ecuador', 62, 'Guayas', 988, '', '[]', 'PayPal Express Checkout', 'pp_express', 'abraham', 'aguirre', '', 'juan tanca', '', 'guayaquil', '12344321', 'Ecuador', 62, 'Guayas', 988, '', '[]', 'Flat Shipping Rate', 'flat.flat', '', 21.8000, 0, 0, 0.0000, 0, '', 1, 2, 'USD', 1.00000000, '200.9.176.9', '', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/51.0.2704.103 Safari/537.36', 'es-ES,es;q=0.8,en;q=0.6,pt;q=0.4,gl;q=0.2', '2016-07-26 16:20:31', '2016-07-26 16:20:31');
INSERT INTO `oc_order` VALUES (11, 0, 'INV-2016-00', 0, 'Expigo', 'http://expigo.com/ecommerce/', 8, 1, 'abraham', 'aguirre', 'ynunez@espol.edu.ec', '12344321', '', '', 'abraham', 'aguirre', '', 'juan tanca', '', 'guayaquil', '12344321', 'Ecuador', 62, 'Guayas', 988, '', '[]', 'Bank Transfer', 'bank_transfer', 'abraham', 'aguirre', '', 'juan tanca', '', 'guayaquil', '12344321', 'Ecuador', 62, 'Guayas', 988, '', '[]', 'Flat Shipping Rate', 'flat.flat', '', 21.8000, 0, 0, 0.0000, 0, '', 1, 2, 'USD', 1.00000000, '200.9.176.9', '', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/51.0.2704.103 Safari/537.36', 'es-ES,es;q=0.8,en;q=0.6,pt;q=0.4,gl;q=0.2', '2016-07-26 16:23:17', '2016-07-26 16:23:17');
INSERT INTO `oc_order` VALUES (12, 0, 'INV-2016-00', 0, 'Expigo', 'http://expigo.com/ecommerce/', 8, 1, 'abraham', 'aguirre', 'ynunez@espol.edu.ec', '12344321', '', '', 'abraham', 'aguirre', '', 'juan tanca', '', 'guayaquil', '12344321', 'Ecuador', 62, 'Guayas', 988, '', '[]', 'PayPal Express Checkout', 'pp_express', 'abraham', 'aguirre', '', 'juan tanca', '', 'guayaquil', '12344321', 'Ecuador', 62, 'Guayas', 988, '', '[]', 'Flat Shipping Rate', 'flat.flat', '', 21.8000, 0, 0, 0.0000, 0, '', 1, 2, 'USD', 1.00000000, '200.9.176.9', '', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/51.0.2704.103 Safari/537.36', 'es-ES,es;q=0.8,en;q=0.6,pt;q=0.4,gl;q=0.2', '2016-07-26 16:23:31', '2016-07-26 16:23:31');
INSERT INTO `oc_order` VALUES (13, 0, 'INV-2016-00', 0, 'Expigo', 'http://expigo.com/ecommerce/', 8, 1, 'abraham', 'aguirre', 'ynunez@espol.edu.ec', '12344321', '', '', 'abraham', 'aguirre', '', 'juan tanca', '', 'guayaquil', '12344321', 'Ecuador', 62, 'Guayas', 988, '', '[]', 'Bank Transfer', 'bank_transfer', 'abraham', 'aguirre', '', 'juan tanca', '', 'guayaquil', '12344321', 'Ecuador', 62, 'Guayas', 988, '', '[]', 'Flat Shipping Rate', 'flat.flat', '', 21.8000, 0, 0, 0.0000, 0, '', 1, 2, 'USD', 1.00000000, '200.9.176.9', '', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/51.0.2704.103 Safari/537.36', 'es-ES,es;q=0.8,en;q=0.6,pt;q=0.4,gl;q=0.2', '2016-07-26 16:37:52', '2016-07-26 16:37:52');
INSERT INTO `oc_order` VALUES (14, 0, 'INV-2016-00', 0, 'Expigo', 'http://expigo.com/ecommerce/', 8, 1, 'abraham', 'aguirre', 'ynunez@espol.edu.ec', '12344321', '', '', 'abraham', 'aguirre', '', 'juan tanca', '', 'guayaquil', '12344321', 'Ecuador', 62, 'Guayas', 988, '', '[]', 'PayPal Express Checkout', 'pp_express', 'abraham', 'aguirre', '', 'juan tanca', '', 'guayaquil', '12344321', 'Ecuador', 62, 'Guayas', 988, '', '[]', 'Flat Shipping Rate', 'flat.flat', '', 21.8000, 0, 0, 0.0000, 0, '', 1, 2, 'USD', 1.00000000, '200.9.176.9', '', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/51.0.2704.103 Safari/537.36', 'es-ES,es;q=0.8,en;q=0.6,pt;q=0.4,gl;q=0.2', '2016-07-26 16:38:00', '2016-07-26 16:38:00');
INSERT INTO `oc_order` VALUES (15, 0, 'INV-2016-00', 0, 'Expigo', 'http://expigo.com/ecommerce/', 8, 1, 'abraham', 'aguirre', 'ynunez@espol.edu.ec', '12344321', '', '', 'abraham', 'aguirre', '', 'juan tanca', '', 'guayaquil', '12344321', 'Ecuador', 62, 'Guayas', 988, '', '[]', 'PayPal Express Checkout', 'pp_express', 'abraham', 'aguirre', '', 'juan tanca', '', 'guayaquil', '12344321', 'Ecuador', 62, 'Guayas', 988, '', '[]', 'Flat Shipping Rate', 'flat.flat', '', 21.8000, 0, 0, 0.0000, 0, '', 1, 2, 'USD', 1.00000000, '200.9.176.9', '', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/51.0.2704.103 Safari/537.36', 'es-ES,es;q=0.8,en;q=0.6,pt;q=0.4,gl;q=0.2', '2016-07-26 17:21:28', '2016-07-26 17:21:28');
INSERT INTO `oc_order` VALUES (16, 0, 'INV-2016-00', 0, 'Expigo', 'http://expigo.com/ecommerce/', 9, 1, 'Fernando', 'Campaña', 'fercamp09@gmail.com', '2233456', '', '', 'Fernando', 'Campaña', '', 'Alborada etapa 3 mz 1', '', 'Guayaquil', '2113', 'Ecuador', 62, 'Guayas', 988, '', '[]', 'Transferencia Bancaria', 'bank_transfer', 'Fernando', 'Campaña', '', 'Alborada etapa 3 mz 1', '', 'Guayaquil', '2113', 'Ecuador', 62, 'Guayas', 988, '', '[]', 'Tarifa plana de env&iacute;o', 'flat.flat', '', 24.9900, 15, 0, 0.0000, 0, '', 2, 2, 'USD', 1.00000000, '186.66.33.238', '', 'Mozilla/5.0 (Windows NT 6.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/49.0.2623.112 Safari/537.36', 'es-ES,es;q=0.8', '2016-07-31 21:23:26', '2016-07-31 21:45:31');
INSERT INTO `oc_order` VALUES (17, 0, 'INV-2016-00', 0, 'Expigo', 'http://expigo.com/ecommerce/', 10, 1, 'Leonardo', 'Eras', 'leonardoeras30@gmail.com', '0986787173', '1234', '', 'Leonardo', 'Eras', '', 'Guayacanes Mz 124 V1', '', 'Guayaquil', '', 'Ecuador', 62, 'Guayas', 988, '', '[]', 'Bank Transfer', 'bank_transfer', 'Leonardo', 'Eras', '', 'Guayacanes Mz 124 V1', '', 'Guayaquil', '', 'Ecuador', 62, 'Guayas', 988, '', '[]', 'Flat Shipping Rate', 'flat.flat', '', 8.6000, 7, 0, 0.0000, 0, '', 1, 2, 'USD', 1.00000000, '190.155.164.230', '', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/51.0.2704.103 Safari/537.36', 'en-US,en;q=0.8', '2016-07-31 21:51:21', '2016-07-31 21:51:24');
INSERT INTO `oc_order` VALUES (18, 0, 'INV-2016-00', 0, 'Expigo', 'http://expigo.com/ecommerce/', 11, 1, 'Pepe', 'Lucho', 'anrosant@espol.edu.ec', '1231', '', '', 'Pepe', 'Lucho', '', 'Guasmito1', '', 'Guayaquil', '3244', 'Ecuador', 62, 'Guayas', 988, '', '[]', 'Transferencia Bancaria', 'bank_transfer', 'Pepe', 'Lucho', '', 'Guasmito1', '', 'Guayaquil', '3244', 'Ecuador', 62, 'Guayas', 988, '', '[]', 'Tarifa plana de env&iacute;o', 'flat.flat', '', 3.6000, 7, 0, 0.0000, 0, '', 2, 2, 'USD', 1.00000000, '200.9.176.9', '', 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/51.0.2704.103 Safari/537.36', 'en-US,en;q=0.8,es;q=0.6', '2016-08-01 13:45:01', '2016-08-01 13:45:25');
INSERT INTO `oc_order` VALUES (19, 0, 'INV-2016-00', 0, 'Expigo', 'http://expigo.com/ecommerce/', 1, 1, 'Yamil', 'Nuñez', 'yamil.nunez@gmail.com', '0995951600', '', '', 'Yamil', 'Nuñez', 'Skysite', 'juan tanca', '', 'guayaquil', 'ec091191', 'Ecuador', 62, 'Guayas', 988, '', '[]', 'PayPal Express Checkout', 'pp_express', 'Yamil', 'Nuñez', 'Skysite', 'juan tanca', '', 'guayaquil', 'ec091191', 'Ecuador', 62, 'Guayas', 988, '', '[]', 'Flat Shipping Rate', 'flat.flat', '', 3.6000, 0, 0, 0.0000, 0, '', 1, 2, 'USD', 1.00000000, '186.101.235.61', '', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/52.0.2743.116 Safari/537.36', 'es-ES,es;q=0.8,en;q=0.6,pt;q=0.4,gl;q=0.2', '2016-08-16 13:52:43', '2016-08-16 13:52:43');

-- --------------------------------------------------------

-- 
-- Estructura de tabla para la tabla `oc_order_custom_field`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_order_custom_field`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_order_history`
-- 

INSERT INTO `oc_order_history` VALUES (1, 1, 1, 0, '', '2016-06-07 16:54:34');
INSERT INTO `oc_order_history` VALUES (2, 2, 1, 0, '', '2016-06-13 16:03:43');
INSERT INTO `oc_order_history` VALUES (3, 3, 1, 0, '', '2016-06-21 21:28:52');
INSERT INTO `oc_order_history` VALUES (4, 4, 1, 0, '', '2016-07-18 17:06:12');
INSERT INTO `oc_order_history` VALUES (5, 5, 1, 0, '', '2016-07-18 17:08:33');
INSERT INTO `oc_order_history` VALUES (6, 7, 7, 1, 'Bank Transfer Instructions\n\nInstructions\n\nYour order will not ship until we receive payment.', '2016-07-25 21:39:56');
INSERT INTO `oc_order_history` VALUES (7, 16, 7, 1, 'Instrucciones para Transferencia Bancaria\n\nInstrucciones\n\nSu pedido no se enviar&aacute; hasta que recibamos el pago.', '2016-07-31 21:24:30');
INSERT INTO `oc_order_history` VALUES (8, 16, 2, 0, '', '2016-07-31 21:41:47');
INSERT INTO `oc_order_history` VALUES (9, 16, 15, 1, 'Your order has been processed', '2016-07-31 21:45:31');
INSERT INTO `oc_order_history` VALUES (10, 17, 7, 1, 'Bank Transfer Instructions\n\nInstructions\n\nYour order will not ship until we receive payment.', '2016-07-31 21:51:24');
INSERT INTO `oc_order_history` VALUES (11, 18, 7, 1, 'Instrucciones para Transferencia Bancaria\n\nInstrucciones\n\nSu pedido no se enviar&aacute; hasta que recibamos el pago.', '2016-08-01 13:45:25');
...
-- 
-- Volcar la base de datos para la tabla `oc_order_option`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_order_product`
-- 
...
INSERT INTO `oc_order_product` VALUES (3, 3, 51, 'Vilcabamba coffee 1 Kg.', '1 kg.', 20, 10.6600, 213.2000, 0.0000, 0);
INSERT INTO `oc_order_product` VALUES (4, 4, 56, 'Special Blend Coffee', '350 g.', 1, 3.6000, 3.6000, 0.0000, 0);
INSERT INTO `oc_order_product` VALUES (5, 4, 55, 'Zaruma Coffe 2 Kg.', '2 Kg.', 1, 13.8000, 13.8000, 0.0000, 0);
INSERT INTO `oc_order_product` VALUES (6, 4, 57, 'Galápagos Coffe', '2kg.', 1, 16.8000, 16.8000, 0.0000, 0);
INSERT INTO `oc_order_product` VALUES (7, 4, 52, 'Vilcabamba Coffee 2 Kg.', '2 Kg.', 1, 19.9900, 19.9900, 0.0000, 0);
INSERT INTO `oc_order_product` VALUES (8, 5, 51, 'Vilcabamba coffee 1 Kg.', '1 kg.', 1, 10.6600, 10.6600, 0.0000, 0);
INSERT INTO `oc_order_product` VALUES (9, 5, 52, 'Vilcabamba Coffee 2 Kg.', '2 Kg.', 1, 19.9900, 19.9900, 0.0000, 0);
INSERT INTO `oc_order_product` VALUES (10, 6, 56, 'Special Blend Coffee', '350 g.', 1, 3.6000, 3.6000, 0.0000, 0);
INSERT INTO `oc_order_product` VALUES (11, 7, 56, 'Special Blend Coffee', '350 g.', 1, 3.6000, 3.6000, 0.0000, 0);
INSERT INTO `oc_order_product` VALUES (12, 8, 57, 'Galápagos Coffe', '2kg.', 1, 16.8000, 16.8000, 0.0000, 0);
INSERT INTO `oc_order_product` VALUES (13, 9, 57, 'Galápagos Coffe', '2kg.', 1, 16.8000, 16.8000, 0.0000, 0);
INSERT INTO `oc_order_product` VALUES (14, 10, 57, 'Galápagos Coffe', '2kg.', 1, 16.8000, 16.8000, 0.0000, 0);
INSERT INTO `oc_order_product` VALUES (15, 11, 57, 'Galápagos Coffe', '2kg.', 1, 16.8000, 16.8000, 0.0000, 0);
INSERT INTO `oc_order_product` VALUES (16, 12, 57, 'Galápagos Coffe', '2kg.', 1, 16.8000, 16.8000, 0.0000, 0);
INSERT INTO `oc_order_product` VALUES (17, 13, 57, 'Galápagos Coffe', '2kg.', 1, 16.8000, 16.8000, 0.0000, 0);
INSERT INTO `oc_order_product` VALUES (18, 14, 57, 'Galápagos Coffe', '2kg.', 1, 16.8000, 16.8000, 0.0000, 0);
INSERT INTO `oc_order_product` VALUES (19, 15, 57, 'Galápagos Coffe', '2kg.', 1, 16.8000, 16.8000, 0.0000, 0);
INSERT INTO `oc_order_product` VALUES (20, 16, 52, 'Vilcabamba Coffee 2 Kg.', '2 Kg.', 1, 19.9900, 19.9900, 0.0000, 0);
INSERT INTO `oc_order_product` VALUES (21, 17, 56, 'Special Blend Coffee', '350 g.', 1, 3.6000, 3.6000, 0.0000, 0);
INSERT INTO `oc_order_product` VALUES (22, 18, 56, 'Special Blend Coffee', '350 g.', 1, 3.6000, 3.6000, 0.0000, 0);
INSERT INTO `oc_order_product` VALUES (23, 19, 56, 'Special Blend Coffee', '350 g.', 1, 3.6000, 3.6000, 0.0000, 0);

-- --------------------------------------------------------

-- 
-- Estructura de tabla para la tabla `oc_order_recurring`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_order_recurring`
-- 
...
-- 
-- Estructura de tabla para la tabla `oc_order_recurring_transaction`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_order_recurring_transaction`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_order_status`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_order_total`
-- 
...
INSERT INTO `oc_order_total` VALUES (7, 3, 'sub_total', 'Sub-Total', 213.2000, 1);
INSERT INTO `oc_order_total` VALUES (8, 3, 'shipping', 'Flat Shipping Rate', 5.0000, 3);
INSERT INTO `oc_order_total` VALUES (9, 3, 'total', 'Total', 218.2000, 9);
INSERT INTO `oc_order_total` VALUES (10, 4, 'sub_total', 'Sub-Total', 54.1900, 1);
INSERT INTO `oc_order_total` VALUES (11, 4, 'shipping', 'Flat Shipping Rate', 5.0000, 3);
INSERT INTO `oc_order_total` VALUES (12, 4, 'total', 'Total', 59.1900, 9);
INSERT INTO `oc_order_total` VALUES (13, 5, 'sub_total', 'Sub-Total', 30.6500, 1);
INSERT INTO `oc_order_total` VALUES (14, 5, 'shipping', 'Flat Shipping Rate', 5.0000, 3);
INSERT INTO `oc_order_total` VALUES (15, 5, 'total', 'Total', 35.6500, 9);
INSERT INTO `oc_order_total` VALUES (16, 6, 'sub_total', 'Sub-Total', 3.6000, 1);
INSERT INTO `oc_order_total` VALUES (17, 6, 'shipping', 'Flat Shipping Rate', 5.0000, 3);
INSERT INTO `oc_order_total` VALUES (18, 6, 'total', 'Total', 8.6000, 9);
INSERT INTO `oc_order_total` VALUES (19, 7, 'sub_total', 'Sub-Total', 3.6000, 1);
INSERT INTO `oc_order_total` VALUES (20, 7, 'shipping', 'Flat Shipping Rate', 5.0000, 3);
INSERT INTO `oc_order_total` VALUES (21, 7, 'total', 'Total', 8.6000, 9);
INSERT INTO `oc_order_total` VALUES (22, 8, 'sub_total', 'Sub-Total', 16.8000, 1);
INSERT INTO `oc_order_total` VALUES (23, 8, 'shipping', 'Flat Shipping Rate', 5.0000, 3);
INSERT INTO `oc_order_total` VALUES (24, 8, 'total', 'Total', 21.8000, 9);
INSERT INTO `oc_order_total` VALUES (25, 9, 'sub_total', 'Sub-Total', 16.8000, 1);
INSERT INTO `oc_order_total` VALUES (26, 9, 'shipping', 'Flat Shipping Rate', 5.0000, 3);
INSERT INTO `oc_order_total` VALUES (27, 9, 'total', 'Total', 21.8000, 9);
INSERT INTO `oc_order_total` VALUES (28, 10, 'sub_total', 'Sub-Total', 16.8000, 1);
INSERT INTO `oc_order_total` VALUES (29, 10, 'shipping', 'Flat Shipping Rate', 5.0000, 3);
INSERT INTO `oc_order_total` VALUES (30, 10, 'total', 'Total', 21.8000, 9);
INSERT INTO `oc_order_total` VALUES (31, 11, 'sub_total', 'Sub-Total', 16.8000, 1);
INSERT INTO `oc_order_total` VALUES (32, 11, 'shipping', 'Flat Shipping Rate', 5.0000, 3);
INSERT INTO `oc_order_total` VALUES (33, 11, 'total', 'Total', 21.8000, 9);
INSERT INTO `oc_order_total` VALUES (34, 12, 'sub_total', 'Sub-Total', 16.8000, 1);
INSERT INTO `oc_order_total` VALUES (35, 12, 'shipping', 'Flat Shipping Rate', 5.0000, 3);
INSERT INTO `oc_order_total` VALUES (36, 12, 'total', 'Total', 21.8000, 9);
INSERT INTO `oc_order_total` VALUES (37, 13, 'sub_total', 'Sub-Total', 16.8000, 1);
INSERT INTO `oc_order_total` VALUES (38, 13, 'shipping', 'Flat Shipping Rate', 5.0000, 3);
INSERT INTO `oc_order_total` VALUES (39, 13, 'total', 'Total', 21.8000, 9);
INSERT INTO `oc_order_total` VALUES (40, 14, 'sub_total', 'Sub-Total', 16.8000, 1);
INSERT INTO `oc_order_total` VALUES (41, 14, 'shipping', 'Flat Shipping Rate', 5.0000, 3);
INSERT INTO `oc_order_total` VALUES (42, 14, 'total', 'Total', 21.8000, 9);
INSERT INTO `oc_order_total` VALUES (43, 15, 'sub_total', 'Sub-Total', 16.8000, 1);
INSERT INTO `oc_order_total` VALUES (44, 15, 'shipping', 'Flat Shipping Rate', 5.0000, 3);
INSERT INTO `oc_order_total` VALUES (45, 15, 'total', 'Total', 21.8000, 9);
INSERT INTO `oc_order_total` VALUES (46, 16, 'sub_total', 'Sub-Total', 19.9900, 1);
INSERT INTO `oc_order_total` VALUES (47, 16, 'shipping', 'Tarifa plana de env&iacute;o', 5.0000, 3);
INSERT INTO `oc_order_total` VALUES (48, 16, 'total', 'Total', 24.9900, 9);
INSERT INTO `oc_order_total` VALUES (49, 17, 'sub_total', 'Sub-Total', 3.6000, 1);
INSERT INTO `oc_order_total` VALUES (50, 17, 'shipping', 'Flat Shipping Rate', 5.0000, 3);
INSERT INTO `oc_order_total` VALUES (51, 17, 'total', 'Total', 8.6000, 9);
INSERT INTO `oc_order_total` VALUES (52, 18, 'sub_total', 'Sub-Total', 3.6000, 1);
INSERT INTO `oc_order_total` VALUES (53, 18, 'total', 'Total', 3.6000, 9);
INSERT INTO `oc_order_total` VALUES (54, 19, 'sub_total', 'Sub-Total', 3.6000, 1);
INSERT INTO `oc_order_total` VALUES (55, 19, 'total', 'Total', 3.6000, 9);
...
-- 
-- Volcar la base de datos para la tabla `oc_order_voucher`
-- 
...
-- 
-- Estructura de tabla para la tabla `oc_paypal_order`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_paypal_order`
-- 
...
-- 
-- Estructura de tabla para la tabla `oc_paypal_order_transaction`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_paypal_order_transaction`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_product`
-- 

INSERT INTO `oc_product` VALUES (52, '2 Kg.', '', '', '', '', '', '', '', 998, 6, 'catalog/vilcabamba.jpg', 0, 1, 19.9900, 0, 0, '2016-06-20', 2.00000000, 1, 0.00000000, 0.00000000, 0.00000000, 1, 1, 1, 1, 1, 22, '2016-06-20 12:05:40', '2016-06-21 13:30:32');
INSERT INTO `oc_product` VALUES (53, '350g', '', '', '', '', '', '', '', 1000, 6, 'catalog/c_zaruma.jpg', 0, 1, 5.9900, 0, 0, '2016-06-21', 350.00000000, 2, 0.00000000, 0.00000000, 0.00000000, 1, 1, 1, 1, 1, 6, '2016-06-21 12:50:19', '2016-06-21 13:21:29');
INSERT INTO `oc_product` VALUES (54, '1 Kg.', '', '', '', '', '', '', '', 1000, 6, 'catalog/c_zaruma.jpg', 0, 1, 9.9900, 0, 0, '2016-06-21', 1.00000000, 1, 0.00000000, 0.00000000, 0.00000000, 1, 1, 1, 1, 1, 6, '2016-06-21 12:58:39', '2016-06-21 13:21:37');
INSERT INTO `oc_product` VALUES (55, '2 Kg.', '', '', '', '', '', '', '', 999, 6, 'catalog/c_zaruma.jpg', 0, 1, 13.8000, 0, 0, '2016-06-21', 2.00000000, 1, 0.00000000, 0.00000000, 0.00000000, 1, 1, 1, 1, 1, 8, '2016-06-21 13:21:19', '2016-06-21 13:22:15');
INSERT INTO `oc_product` VALUES (56, '350 g.', '', '', '', '', '', '', '', 999, 6, 'catalog/c_blended.jpg', 0, 1, 3.6000, 0, 0, '2016-06-21', 350.00000000, 2, 0.00000000, 0.00000000, 0.00000000, 1, 1, 1, 1, 1, 23, '2016-06-21 13:50:41', '2016-06-21 13:51:13');
INSERT INTO `oc_product` VALUES (57, '2kg.', '', '', '', '', '', '', '', 999, 6, 'catalog/galapagos.jpg', 0, 1, 16.8000, 0, 0, '2016-06-21', 2.00000000, 1, 0.00000000, 0.00000000, 0.00000000, 1, 1, 1, 1, 1, 7, '2016-06-21 14:03:28', '0000-00-00 00:00:00');
INSERT INTO `oc_product` VALUES (51, '1 kg.', '', '', '', '', '', '', '', 979, 6, 'catalog/vilcabamba.jpg', 0, 1, 10.6600, 0, 0, '2016-06-20', 1.00000000, 1, 0.00000000, 0.00000000, 0.00000000, 1, 1, 1, 1, 1, 9, '2016-06-20 12:04:35', '2016-06-21 13:28:44');
INSERT INTO `oc_product` VALUES (50, '350g.', '', '', '', '', '', '', '', 1000, 6, 'catalog/vilcabamba.jpg', 0, 0, 4.6300, 0, 0, '2016-06-20', 350.00000000, 2, 0.00000000, 0.00000000, 0.00000000, 1, 1, 1, 1, 1, 10, '2016-06-20 10:54:08', '2016-07-18 21:20:30');
...
-- 
-- Volcar la base de datos para la tabla `oc_product_attribute`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_product_description`
-- 

INSERT INTO `oc_product_description` VALUES (51, 2, 'Vilcabamba coffee 1 Kg.', '&lt;h2&gt;Vilcabamba coffee&lt;/h2&gt;\r\n \r\n&lt;h5&gt;100% Organic&lt;/h5&gt;\r\n \r\n&lt;p&gt;The coffee we process and treat comes from Vilcabamba, the Sacred Valley, named by the Incas. It is located south of the country, a few kilometers from the city of Loja, capital of the province of the same name.&lt;/p&gt;\r\n&lt;p&gt;Here is produced the Arabica coffee at 1.200 to 1.900 meters above sea level. Its temperature ranges between 18 and 28 C. It has been called the lost paradise, because in its generous land, is produced extraordinary fruits that provide food to the inhabitants of this mysterious valley. In some areas you can see the cane fields, corn and coffee crops in the very picturesque countryside, in a peaceful region.&lt;/p&gt;\r\n&lt;p&gt;Better known as the Valley of Longevity, by the large population that exceed 100 years old. His peaceful life, food, water, climate and the benefits of their fruits make its inhabitants in exceptional protagonists&lt;/p&gt;\r\n\r\n&lt;p&gt;&lt;br&gt;&lt;/p&gt;&lt;p&gt;&lt;u&gt;Loja Highland washed Arabica Coffee&lt;/u&gt;&lt;/p&gt;&lt;p&gt;&lt;br&gt;&lt;/p&gt;&lt;p style=&quot;line-height: 17.1428px;&quot;&gt;&lt;b&gt;Aroma-Fragancia:&lt;/b&gt;&amp;nbsp;Floral, Frutal&amp;nbsp; &amp;nbsp;&lt;/p&gt;&lt;p style=&quot;line-height: 17.1428px;&quot;&gt;&lt;b&gt;Cuerpo:&lt;/b&gt;&amp;nbsp;Suave / Equilibrio&lt;/p&gt;&lt;p style=&quot;line-height: 17.1428px;&quot;&gt;&lt;b&gt;Acidez:&lt;/b&gt;&amp;nbsp;Intensa&lt;/p&gt;&lt;p style=&quot;line-height: 17.1428px;&quot;&gt;&lt;b&gt;Sabor:&lt;/b&gt;&amp;nbsp;Frutal, suave&lt;/p&gt;&lt;p style=&quot;line-height: 17.1428px;&quot;&gt;&lt;b&gt;After-Taste:&lt;/b&gt;&amp;nbsp;Frutal&lt;/p&gt;', '', 'Expigo Vilcabamba coffee 1 Kg.', 'Expigo Vilcabamba coffee 1 Kg.', 'Expigo Vilcabamba coffee 1 Kg.');
INSERT INTO `oc_product_description` VALUES (52, 1, 'Vilcabamba Coffee 2 Kg.', '&lt;h2&gt;Vilcabamba coffee&lt;/h2&gt;\r\n \r\n&lt;h5&gt;100% Organic&lt;/h5&gt;\r\n \r\n&lt;p&gt;The coffee we process and treat comes from Vilcabamba, the Sacred Valley, named by the Incas. It is located south of the country, a few kilometers from the city of Loja, capital of the province of the same name.&lt;/p&gt;\r\n&lt;p&gt;Here is produced the Arabica coffee at 1.200 to 1.900 meters above sea level. Its temperature ranges between 18 and 28 C. It has been called the lost paradise, because in its generous land, is produced extraordinary fruits that provide food to the inhabitants of this mysterious valley. In some areas you can see the cane fields, corn and coffee crops in the very picturesque countryside, in a peaceful region.&lt;/p&gt;\r\n&lt;p&gt;Better known as the Valley of Longevity, by the large population that exceed 100 years old. His peaceful life, food, water, climate and the benefits of their fruits make its inhabitants in exceptional protagonists&lt;/p&gt;\r\n\r\n&lt;p&gt;&lt;br&gt;&lt;/p&gt;&lt;p&gt;&lt;u&gt;Loja Highland washed Arabica Coffee&lt;/u&gt;&lt;/p&gt;&lt;p&gt;&lt;br&gt;&lt;/p&gt;&lt;p style=&quot;line-height: 17.1428px;&quot;&gt;&lt;b&gt;Aroma-Fragancia:&lt;/b&gt;&amp;nbsp;Floral, Frutal&amp;nbsp; &amp;nbsp;&lt;/p&gt;&lt;p style=&quot;line-height: 17.1428px;&quot;&gt;&lt;b&gt;Cuerpo:&lt;/b&gt;&amp;nbsp;Suave / Equilibrio&lt;/p&gt;&lt;p style=&quot;line-height: 17.1428px;&quot;&gt;&lt;b&gt;Acidez:&lt;/b&gt;&amp;nbsp;Intensa&lt;/p&gt;&lt;p style=&quot;line-height: 17.1428px;&quot;&gt;&lt;b&gt;Sabor:&lt;/b&gt;&amp;nbsp;Frutal, suave&lt;/p&gt;&lt;p style=&quot;line-height: 17.1428px;&quot;&gt;&lt;b&gt;After-Taste:&lt;/b&gt;&amp;nbsp;Frutal&lt;/p&gt;', '', 'Expigo Vilcabamba Coffee 2 Kg.', 'Expigo Vilcabamba Coffee 2 Kg.', 'Expigo Vilcabamba Coffee 2 Kg.');
INSERT INTO `oc_product_description` VALUES (50, 2, 'Vilcabamba Coffee 350g.', '&lt;h2&gt;Vilcabamba coffee&lt;/h2&gt;\r\n \r\n&lt;h5&gt;100% Organic&lt;/h5&gt;\r\n \r\n&lt;p&gt;The coffee we process and treat comes from Vilcabamba, the Sacred Valley, named by the Incas. It is located south of the country, a few kilometers from the city of Loja, capital of the province of the same name.&lt;/p&gt;\r\n&lt;p&gt;Here is produced the Arabica coffee at 1.200 to 1.900 meters above sea level. Its temperature ranges between 18 and 28 C. It has been called the lost paradise, because in its generous land, is produced extraordinary fruits that provide food to the inhabitants of this mysterious valley. In some areas you can see the cane fields, corn and coffee crops in the very picturesque countryside, in a peaceful region.&lt;/p&gt;\r\n&lt;p&gt;Better known as the Valley of Longevity, by the large population that exceed 100 years old. His peaceful life, food, water, climate and the benefits of their fruits make its inhabitants in exceptional protagonists&lt;/p&gt;\r\n\r\n&lt;p&gt;&lt;br&gt;&lt;/p&gt;&lt;p&gt;&lt;u&gt;Loja Highland washed Arabica Coffee&lt;/u&gt;&lt;/p&gt;&lt;p&gt;&lt;br&gt;&lt;/p&gt;&lt;p style=&quot;line-height: 17.1428px;&quot;&gt;&lt;b&gt;Aroma-Fragancia:&lt;/b&gt;&amp;nbsp;Floral, Frutal&amp;nbsp; &amp;nbsp;&lt;/p&gt;&lt;p style=&quot;line-height: 17.1428px;&quot;&gt;&lt;b&gt;Cuerpo:&lt;/b&gt;&amp;nbsp;Suave / Equilibrio&lt;/p&gt;&lt;p style=&quot;line-height: 17.1428px;&quot;&gt;&lt;b&gt;Acidez:&lt;/b&gt;&amp;nbsp;Intensa&lt;/p&gt;&lt;p style=&quot;line-height: 17.1428px;&quot;&gt;&lt;b&gt;Sabor:&lt;/b&gt;&amp;nbsp;Frutal, suave&lt;/p&gt;&lt;p style=&quot;line-height: 17.1428px;&quot;&gt;&lt;b&gt;After-Taste:&lt;/b&gt;&amp;nbsp;Frutal&lt;/p&gt;', '', 'vilcabamba-300g', '', '');
INSERT INTO `oc_product_description` VALUES (56, 1, 'Special Blend Coffee', '\r\n&lt;h2&gt;Vilcabamba coffee&lt;/h2&gt;\r\n \r\n&lt;p&gt;This product comes from experience of our tasters who have managed to mix mild Arabica coffee with Ecuadorian Amazon Coffee (robust), recognized for its high quality and specific qualities of the variety, such as excellent taste, strong body and high performance in roasting.&lt;/p&gt;\r\n\r\n&lt;p&gt;They are grains obtained by natural processes, which produce a cup of excellent flavor; aroma and balanced body.&lt;/p&gt;', '', 'Special Blend Coffee', 'Special Blend Coffee', 'Special Blend Coffee');
INSERT INTO `oc_product_description` VALUES (57, 1, 'Galápagos Coffe', '&lt;h2&gt;Galápagos Coffe&lt;/h2&gt;\r\n \r\n&lt;p&gt;In San Cristobal one of the largest island of the Galapagos Archipielago, the atmosphere sorrounded by this Humbolt current, he sea breeze, and the latitude, makes the differents flora and fauna creating a microclimate. From 0 to 50 mts. A.s.l the desert is dominant with cactus and another endemic plants.&lt;/p&gt;\r\n\r\n&lt;p&gt;At 150 to 350 mts a.s.l. equivalent to 450 to 1200 mts A.s.l. in the mainland, the flora is luxurious and the coffee trees grow under a forest of canopy. WHERE is our &quot;Hacienda El Cafetal&quot;, where the plants enjoy of abundance of fresh spring water that come from small rivers fed by the &quot;El JUNCO&quot; a volcanic crater lake, which lies at 1350 feet a.s.l. flowing gently down slopes. The minerals enrich the water and keeps the volcanic soil moist and fertile and enhance the vegetal diversity of this unique island&lt;/p&gt;', 'Galápagos Coffe', 'Galápagos Coffe', 'Galápagos Coffe', 'Galápagos Coffe');
INSERT INTO `oc_product_description` VALUES (50, 1, 'Vilcabamba Coffee 350g.', '&lt;h2&gt;Vilcabamba coffee&lt;/h2&gt;\r\n \r\n&lt;h5&gt;100% Organic&lt;/h5&gt;\r\n \r\n&lt;p&gt;The coffee we process and treat comes from Vilcabamba, the Sacred Valley, named by the Incas. It is located south of the country, a few kilometers from the city of Loja, capital of the province of the same name.&lt;/p&gt;\r\n&lt;p&gt;Here is produced the Arabica coffee at 1.200 to 1.900 meters above sea level. Its temperature ranges between 18 and 28 C. It has been called the lost paradise, because in its generous land, is produced extraordinary fruits that provide food to the inhabitants of this mysterious valley. In some areas you can see the cane fields, corn and coffee crops in the very picturesque countryside, in a peaceful region.&lt;/p&gt;\r\n&lt;p&gt;Better known as the Valley of Longevity, by the large population that exceed 100 years old. His peaceful life, food, water, climate and the benefits of their fruits make its inhabitants in exceptional protagonists&lt;/p&gt;\r\n\r\n&lt;p&gt;&lt;br&gt;&lt;/p&gt;&lt;p&gt;&lt;u&gt;Loja Highland washed Arabica Coffee&lt;/u&gt;&lt;/p&gt;&lt;p&gt;&lt;br&gt;&lt;/p&gt;&lt;p style=&quot;line-height: 17.1428px;&quot;&gt;&lt;b&gt;Aroma-Fragancia:&lt;/b&gt;&amp;nbsp;Floral, Frutal&amp;nbsp; &amp;nbsp;&lt;/p&gt;&lt;p style=&quot;line-height: 17.1428px;&quot;&gt;&lt;b&gt;Cuerpo:&lt;/b&gt;&amp;nbsp;Suave / Equilibrio&lt;/p&gt;&lt;p style=&quot;line-height: 17.1428px;&quot;&gt;&lt;b&gt;Acidez:&lt;/b&gt;&amp;nbsp;Intensa&lt;/p&gt;&lt;p style=&quot;line-height: 17.1428px;&quot;&gt;&lt;b&gt;Sabor:&lt;/b&gt;&amp;nbsp;Frutal, suave&lt;/p&gt;&lt;p style=&quot;line-height: 17.1428px;&quot;&gt;&lt;b&gt;After-Taste:&lt;/b&gt;&amp;nbsp;Frutal&lt;/p&gt;', '', 'vilcabamba-300g', '', '');
INSERT INTO `oc_product_description` VALUES (52, 2, 'Vilcabamba Coffee 2 Kg.', '&lt;h2&gt;Vilcabamba coffee&lt;/h2&gt;\r\n \r\n&lt;h5&gt;100% Organic&lt;/h5&gt;\r\n \r\n&lt;p&gt;The coffee we process and treat comes from Vilcabamba, the Sacred Valley, named by the Incas. It is located south of the country, a few kilometers from the city of Loja, capital of the province of the same name.&lt;/p&gt;\r\n&lt;p&gt;Here is produced the Arabica coffee at 1.200 to 1.900 meters above sea level. Its temperature ranges between 18 and 28 C. It has been called the lost paradise, because in its generous land, is produced extraordinary fruits that provide food to the inhabitants of this mysterious valley. In some areas you can see the cane fields, corn and coffee crops in the very picturesque countryside, in a peaceful region.&lt;/p&gt;\r\n&lt;p&gt;Better known as the Valley of Longevity, by the large population that exceed 100 years old. His peaceful life, food, water, climate and the benefits of their fruits make its inhabitants in exceptional protagonists&lt;/p&gt;\r\n\r\n&lt;p&gt;&lt;br&gt;&lt;/p&gt;&lt;p&gt;&lt;u&gt;Loja Highland washed Arabica Coffee&lt;/u&gt;&lt;/p&gt;&lt;p&gt;&lt;br&gt;&lt;/p&gt;&lt;p style=&quot;line-height: 17.1428px;&quot;&gt;&lt;b&gt;Aroma-Fragancia:&lt;/b&gt;&amp;nbsp;Floral, Frutal&amp;nbsp; &amp;nbsp;&lt;/p&gt;&lt;p style=&quot;line-height: 17.1428px;&quot;&gt;&lt;b&gt;Cuerpo:&lt;/b&gt;&amp;nbsp;Suave / Equilibrio&lt;/p&gt;&lt;p style=&quot;line-height: 17.1428px;&quot;&gt;&lt;b&gt;Acidez:&lt;/b&gt;&amp;nbsp;Intensa&lt;/p&gt;&lt;p style=&quot;line-height: 17.1428px;&quot;&gt;&lt;b&gt;Sabor:&lt;/b&gt;&amp;nbsp;Frutal, suave&lt;/p&gt;&lt;p style=&quot;line-height: 17.1428px;&quot;&gt;&lt;b&gt;After-Taste:&lt;/b&gt;&amp;nbsp;Frutal&lt;/p&gt;', '', 'Expigo Vilcabamba Coffee 2 Kg.', 'Expigo Vilcabamba Coffee 2 Kg.', 'Expigo Vilcabamba Coffee 2 Kg.');
INSERT INTO `oc_product_description` VALUES (56, 2, 'Special Blend Coffee', '\r\n&lt;h2&gt;Vilcabamba coffee&lt;/h2&gt;\r\n \r\n&lt;p&gt;This product comes from experience of our tasters who have managed to mix mild Arabica coffee with Ecuadorian Amazon Coffee (robust), recognized for its high quality and specific qualities of the variety, such as excellent taste, strong body and high performance in roasting.&lt;/p&gt;\r\n\r\n&lt;p&gt;They are grains obtained by natural processes, which produce a cup of excellent flavor; aroma and balanced body.&lt;/p&gt;', '', 'Special Blend Coffee', 'Special Blend Coffee', 'Special Blend Coffee');
INSERT INTO `oc_product_description` VALUES (53, 1, 'Zaruma Coffee 350g.', '&lt;p&gt;&lt;br&gt;&lt;/p&gt;&lt;p&gt;Coffee selected from the best farms in the upper region of the province of El Oro, a region of Ecuador&amp;nbsp;&lt;span style=&quot;line-height: 17.1428px;&quot;&gt;famous for its coffee&lt;/span&gt;&lt;span style=&quot;line-height: 1.42857;&quot;&gt;, surrounded by mountains over 1200m above sea level, facing the Pacific Ocean, it enjoys a temperate climate and cool throughout the year.&amp;nbsp;&lt;/span&gt;privileged&lt;span style=&quot;line-height: 1.42857;&quot;&gt;&amp;nbsp;region for its biodiversity and&amp;nbsp;&lt;/span&gt;recognized for&lt;span style=&quot;line-height: 1.42857;&quot;&gt;&amp;nbsp;quality of their coffee.&lt;/span&gt;&lt;/p&gt;&lt;p&gt;The cultivation of coffee preserves the native trees in the area such as avocado, guava, banana, they provide shade and a natural habitat for birds of the field. Thanks to this, their beans (washed and natural), allow to make a roast of excellent quality and get a taste and acidity noticeable aroma.&lt;/p&gt;&lt;p&gt;With our roasted beans can develop a healthy drink with delicate taste, aroma and distinguished acidity.&lt;/p&gt;', '', 'Zaruma Coffee', 'Zaruma Coffee', 'Zaruma Coffee');
INSERT INTO `oc_product_description` VALUES (54, 1, 'Zaruma Coffee 1 Kg.', '&lt;p&gt;&lt;br&gt;&lt;/p&gt;&lt;p&gt;Coffee selected from the best farms in the upper region of the province of El Oro, a region of Ecuador&amp;nbsp;&lt;span style=&quot;line-height: 17.1428px;&quot;&gt;famous for its coffee&lt;/span&gt;&lt;span style=&quot;line-height: 1.42857;&quot;&gt;, surrounded by mountains over 1200m above sea level, facing the Pacific Ocean, it enjoys a temperate climate and cool throughout the year.&amp;nbsp;&lt;/span&gt;privileged&lt;span style=&quot;line-height: 1.42857;&quot;&gt;&amp;nbsp;region for its biodiversity and&amp;nbsp;&lt;/span&gt;recognized for&lt;span style=&quot;line-height: 1.42857;&quot;&gt;&amp;nbsp;quality of their coffee.&lt;/span&gt;&lt;/p&gt;&lt;p&gt;The cultivation of coffee preserves the native trees in the area such as avocado, guava, banana, they provide shade and a natural habitat for birds of the field. Thanks to this, their beans (washed and natural), allow to make a roast of excellent quality and get a taste and acidity noticeable aroma.&lt;/p&gt;&lt;p&gt;With our roasted beans can develop a healthy drink with delicate taste, aroma and distinguished acidity.&lt;/p&gt;', '', 'Expigo Zaruma Coffee 1 Kg.', 'Expigo Zaruma Coffee 1 Kg.', 'Expigo Zaruma Coffee 1 Kg.');
INSERT INTO `oc_product_description` VALUES (55, 1, 'Zaruma Coffe 2 Kg.', '&lt;p&gt;&lt;br&gt;&lt;/p&gt;&lt;p&gt;Coffee selected from the best farms in the upper region of the province of El Oro, a region of Ecuador&amp;nbsp;&lt;span style=&quot;line-height: 17.1428px;&quot;&gt;famous for its coffee&lt;/span&gt;&lt;span style=&quot;line-height: 1.42857;&quot;&gt;, surrounded by mountains over 1200m above sea level, facing the Pacific Ocean, it enjoys a temperate climate and cool throughout the year.&amp;nbsp;&lt;/span&gt;privileged&lt;span style=&quot;line-height: 1.42857;&quot;&gt;&amp;nbsp;region for its biodiversity and&amp;nbsp;&lt;/span&gt;recognized for&lt;span style=&quot;line-height: 1.42857;&quot;&gt;&amp;nbsp;quality of their coffee.&lt;/span&gt;&lt;/p&gt;&lt;p&gt;The cultivation of coffee preserves the native trees in the area such as avocado, guava, banana, they provide shade and a natural habitat for birds of the field. Thanks to this, their beans (washed and natural), allow to make a roast of excellent quality and get a taste and acidity noticeable aroma.&lt;/p&gt;&lt;p&gt;With our roasted beans can develop a healthy drink with delicate taste, aroma and distinguished acidity.&lt;/p&gt;', '', 'Zaruma Coffe 2 Kg.', 'Zaruma Coffe 2 Kg.', 'Zaruma Coffe 2 Kg.');
INSERT INTO `oc_product_description` VALUES (51, 1, 'Vilcabamba coffee 1 Kg.', '&lt;h2&gt;Vilcabamba coffee&lt;/h2&gt;\r\n \r\n&lt;h5&gt;100% Organic&lt;/h5&gt;\r\n \r\n&lt;p&gt;The coffee we process and treat comes from Vilcabamba, the Sacred Valley, named by the Incas. It is located south of the country, a few kilometers from the city of Loja, capital of the province of the same name.&lt;/p&gt;\r\n&lt;p&gt;Here is produced the Arabica coffee at 1.200 to 1.900 meters above sea level. Its temperature ranges between 18 and 28 C. It has been called the lost paradise, because in its generous land, is produced extraordinary fruits that provide food to the inhabitants of this mysterious valley. In some areas you can see the cane fields, corn and coffee crops in the very picturesque countryside, in a peaceful region.&lt;/p&gt;\r\n&lt;p&gt;Better known as the Valley of Longevity, by the large population that exceed 100 years old. His peaceful life, food, water, climate and the benefits of their fruits make its inhabitants in exceptional protagonists&lt;/p&gt;\r\n\r\n&lt;p&gt;&lt;br&gt;&lt;/p&gt;&lt;p&gt;&lt;u&gt;Loja Highland washed Arabica Coffee&lt;/u&gt;&lt;/p&gt;&lt;p&gt;&lt;br&gt;&lt;/p&gt;&lt;p style=&quot;line-height: 17.1428px;&quot;&gt;&lt;b&gt;Aroma-Fragancia:&lt;/b&gt;&amp;nbsp;Floral, Frutal&amp;nbsp; &amp;nbsp;&lt;/p&gt;&lt;p style=&quot;line-height: 17.1428px;&quot;&gt;&lt;b&gt;Cuerpo:&lt;/b&gt;&amp;nbsp;Suave / Equilibrio&lt;/p&gt;&lt;p style=&quot;line-height: 17.1428px;&quot;&gt;&lt;b&gt;Acidez:&lt;/b&gt;&amp;nbsp;Intensa&lt;/p&gt;&lt;p style=&quot;line-height: 17.1428px;&quot;&gt;&lt;b&gt;Sabor:&lt;/b&gt;&amp;nbsp;Frutal, suave&lt;/p&gt;&lt;p style=&quot;line-height: 17.1428px;&quot;&gt;&lt;b&gt;After-Taste:&lt;/b&gt;&amp;nbsp;Frutal&lt;/p&gt;', '', 'Expigo Vilcabamba coffee 1 Kg.', 'Expigo Vilcabamba coffee 1 Kg.', 'Expigo Vilcabamba coffee 1 Kg.');
INSERT INTO `oc_product_description` VALUES (57, 2, 'Galápagos Coffe', '&lt;h2&gt;Galápagos Coffe&lt;/h2&gt;\r\n \r\n&lt;p&gt;In San Cristobal one of the largest island of the Galapagos Archipielago, the atmosphere sorrounded by this Humbolt current, he sea breeze, and the latitude, makes the differents flora and fauna creating a microclimate. From 0 to 50 mts. A.s.l the desert is dominant with cactus and another endemic plants.&lt;/p&gt;\r\n\r\n&lt;p&gt;At 150 to 350 mts a.s.l. equivalent to 450 to 1200 mts A.s.l. in the mainland, the flora is luxurious and the coffee trees grow under a forest of canopy. WHERE is our &quot;Hacienda El Cafetal&quot;, where the plants enjoy of abundance of fresh spring water that come from small rivers fed by the &quot;El JUNCO&quot; a volcanic crater lake, which lies at 1350 feet a.s.l. flowing gently down slopes. The minerals enrich the water and keeps the volcanic soil moist and fertile and enhance the vegetal diversity of this unique island&lt;/p&gt;', 'Galápagos Coffe', 'Galápagos Coffe', 'Galápagos Coffe', 'Galápagos Coffe');
INSERT INTO `oc_product_description` VALUES (53, 2, 'Zaruma Coffee 350g.', '&lt;p&gt;&lt;br&gt;&lt;/p&gt;&lt;p&gt;Coffee selected from the best farms in the upper region of the province of El Oro, a region of Ecuador&amp;nbsp;&lt;span style=&quot;line-height: 17.1428px;&quot;&gt;famous for its coffee&lt;/span&gt;&lt;span style=&quot;line-height: 1.42857;&quot;&gt;, surrounded by mountains over 1200m above sea level, facing the Pacific Ocean, it enjoys a temperate climate and cool throughout the year.&amp;nbsp;&lt;/span&gt;privileged&lt;span style=&quot;line-height: 1.42857;&quot;&gt;&amp;nbsp;region for its biodiversity and&amp;nbsp;&lt;/span&gt;recognized for&lt;span style=&quot;line-height: 1.42857;&quot;&gt;&amp;nbsp;quality of their coffee.&lt;/span&gt;&lt;/p&gt;&lt;p&gt;The cultivation of coffee preserves the native trees in the area such as avocado, guava, banana, they provide shade and a natural habitat for birds of the field. Thanks to this, their beans (washed and natural), allow to make a roast of excellent quality and get a taste and acidity noticeable aroma.&lt;/p&gt;&lt;p&gt;With our roasted beans can develop a healthy drink with delicate taste, aroma and distinguished acidity.&lt;/p&gt;', '', 'Zaruma Coffee', 'Zaruma Coffee', 'Zaruma Coffee');
INSERT INTO `oc_product_description` VALUES (54, 2, 'Zaruma Coffee 1 Kg.', '&lt;p&gt;&lt;br&gt;&lt;/p&gt;&lt;p&gt;Coffee selected from the best farms in the upper region of the province of El Oro, a region of Ecuador&amp;nbsp;&lt;span style=&quot;line-height: 17.1428px;&quot;&gt;famous for its coffee&lt;/span&gt;&lt;span style=&quot;line-height: 1.42857;&quot;&gt;, surrounded by mountains over 1200m above sea level, facing the Pacific Ocean, it enjoys a temperate climate and cool throughout the year.&amp;nbsp;&lt;/span&gt;privileged&lt;span style=&quot;line-height: 1.42857;&quot;&gt;&amp;nbsp;region for its biodiversity and&amp;nbsp;&lt;/span&gt;recognized for&lt;span style=&quot;line-height: 1.42857;&quot;&gt;&amp;nbsp;quality of their coffee.&lt;/span&gt;&lt;/p&gt;&lt;p&gt;The cultivation of coffee preserves the native trees in the area such as avocado, guava, banana, they provide shade and a natural habitat for birds of the field. Thanks to this, their beans (washed and natural), allow to make a roast of excellent quality and get a taste and acidity noticeable aroma.&lt;/p&gt;&lt;p&gt;With our roasted beans can develop a healthy drink with delicate taste, aroma and distinguished acidity.&lt;/p&gt;', '', 'Expigo Zaruma Coffee 1 Kg.', 'Expigo Zaruma Coffee 1 Kg.', 'Expigo Zaruma Coffee 1 Kg.');
INSERT INTO `oc_product_description` VALUES (55, 2, 'Zaruma Coffe 2 Kg.', '&lt;p&gt;&lt;br&gt;&lt;/p&gt;&lt;p&gt;Coffee selected from the best farms in the upper region of the province of El Oro, a region of Ecuador&amp;nbsp;&lt;span style=&quot;line-height: 17.1428px;&quot;&gt;famous for its coffee&lt;/span&gt;&lt;span style=&quot;line-height: 1.42857;&quot;&gt;, surrounded by mountains over 1200m above sea level, facing the Pacific Ocean, it enjoys a temperate climate and cool throughout the year.&amp;nbsp;&lt;/span&gt;privileged&lt;span style=&quot;line-height: 1.42857;&quot;&gt;&amp;nbsp;region for its biodiversity and&amp;nbsp;&lt;/span&gt;recognized for&lt;span style=&quot;line-height: 1.42857;&quot;&gt;&amp;nbsp;quality of their coffee.&lt;/span&gt;&lt;/p&gt;&lt;p&gt;The cultivation of coffee preserves the native trees in the area such as avocado, guava, banana, they provide shade and a natural habitat for birds of the field. Thanks to this, their beans (washed and natural), allow to make a roast of excellent quality and get a taste and acidity noticeable aroma.&lt;/p&gt;&lt;p&gt;With our roasted beans can develop a healthy drink with delicate taste, aroma and distinguished acidity.&lt;/p&gt;', '', 'Zaruma Coffe 2 Kg.', 'Zaruma Coffe 2 Kg.', 'Zaruma Coffe 2 Kg.');
...
) ENGINE=MyISAM AUTO_INCREMENT=441 DEFAULT CHARSET=utf8 AUTO_INCREMENT=441 ;

-- 
-- Volcar la base de datos para la tabla `oc_product_discount`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_product_filter`
-- 
...
CREATE TABLE `oc_product_image` (
  ...
  KEY `product_id` (`product_id`)
) ENGINE=MyISAM AUTO_INCREMENT=2362 DEFAULT CHARSET=utf8 AUTO_INCREMENT=2362 ;

-- 
-- Volcar la base de datos para la tabla `oc_product_image`
-- 
...
) ENGINE=MyISAM AUTO_INCREMENT=227 DEFAULT CHARSET=utf8 AUTO_INCREMENT=227 ;

-- 
-- Volcar la base de datos para la tabla `oc_product_option`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_product_option_value`
-- 
...
-- 
-- Estructura de tabla para la tabla `oc_product_recurring`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_product_recurring`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_product_related`
-- 
...
) ENGINE=MyISAM AUTO_INCREMENT=549 DEFAULT CHARSET=utf8 AUTO_INCREMENT=549 ;

-- 
-- Volcar la base de datos para la tabla `oc_product_reward`
-- 
...
CREATE TABLE `oc_product_special` (
  ...
  KEY `product_id` (`product_id`)
) ENGINE=MyISAM AUTO_INCREMENT=440 DEFAULT CHARSET=utf8 AUTO_INCREMENT=440 ;

-- 
-- Volcar la base de datos para la tabla `oc_product_special`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_product_to_category`
-- 
...
INSERT INTO `oc_product_to_category` VALUES (53, 61);
INSERT INTO `oc_product_to_category` VALUES (54, 61);
INSERT INTO `oc_product_to_category` VALUES (55, 61);
INSERT INTO `oc_product_to_category` VALUES (56, 62);
INSERT INTO `oc_product_to_category` VALUES (57, 60);
...
-- 
-- Volcar la base de datos para la tabla `oc_product_to_download`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_product_to_layout`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_product_to_store`
-- 
...
-- 
-- Estructura de tabla para la tabla `oc_recurring`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_recurring`
-- 
...
-- 
-- Estructura de tabla para la tabla `oc_recurring_description`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_recurring_description`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_return`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_return_action`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_return_history`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_return_reason`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_return_status`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_review`
-- 

INSERT INTO `oc_review` VALUES (1, 56, 0, 'Leonardo', 'El cafe es muy bueno para la salud porque tiene muchos componentes adictivos deliciosos', 5, 0, '2016-07-18 16:35:00', '0000-00-00 00:00:00');
INSERT INTO `oc_review` VALUES (2, 52, 0, 'Gabriel Aumala', 'No me gusta', 2, 1, '2016-07-18 17:00:34', '0000-00-00 00:00:00');
...
) ENGINE=MyISAM AUTO_INCREMENT=1494 DEFAULT CHARSET=utf8 AUTO_INCREMENT=1494 ;

-- 
-- Volcar la base de datos para la tabla `oc_setting`
-- 
...
INSERT INTO `oc_setting` VALUES (1493, 0, 'google_captcha', 'google_captcha_status', '1', 0);
...
INSERT INTO `oc_setting` VALUES (321, 0, 'category', 'category_status', '1', 0);
...
INSERT INTO `oc_setting` VALUES (1489, 0, 'config', 'config_error_log', '1', 0);
INSERT INTO `oc_setting` VALUES (1490, 0, 'config', 'config_error_filename', 'error.log', 0);
INSERT INTO `oc_setting` VALUES (1491, 0, 'google_captcha', 'google_captcha_key', '6LfKFycTAAAAAMzBDMJw6OSA912R_wwd0yPewGg0', 0);
INSERT INTO `oc_setting` VALUES (1488, 0, 'config', 'config_error_display', '1', 0);
INSERT INTO `oc_setting` VALUES (1487, 0, 'config', 'config_file_mime_allowed', 'text/plain\r\nimage/png\r\nimage/jpeg\r\nimage/gif\r\nimage/bmp\r\nimage/tiff\r\nimage/svg+xml\r\napplication/zip\r\n&quot;application/zip&quot;\r\napplication/x-zip\r\n&quot;application/x-zip&quot;\r\napplication/x-zip-compressed\r\n&quot;application/x-zip-compressed&quot;\r\napplication/rar\r\n&quot;application/rar&quot;\r\napplication/x-rar\r\n&quot;application/x-rar&quot;\r\napplication/x-rar-compressed\r\n&quot;application/x-rar-compressed&quot;\r\napplication/octet-stream\r\n&quot;application/octet-stream&quot;\r\naudio/mpeg\r\nvideo/quicktime\r\napplication/pdf', 0);
INSERT INTO `oc_setting` VALUES (1486, 0, 'config', 'config_file_ext_allowed', 'zip\r\ntxt\r\npng\r\njpe\r\njpeg\r\njpg\r\ngif\r\nbmp\r\nico\r\ntiff\r\ntif\r\nsvg\r\nsvgz\r\nzip\r\nrar\r\nmsi\r\ncab\r\nmp3\r\nqt\r\nmov\r\npdf\r\npsd\r\nai\r\neps\r\nps\r\ndoc', 0);
INSERT INTO `oc_setting` VALUES (1485, 0, 'config', 'config_file_max_size', '300000', 0);
INSERT INTO `oc_setting` VALUES (1480, 0, 'config', 'config_compression', '0', 0);
INSERT INTO `oc_setting` VALUES (1481, 0, 'config', 'config_secure', '0', 0);
INSERT INTO `oc_setting` VALUES (1482, 0, 'config', 'config_password', '1', 0);
INSERT INTO `oc_setting` VALUES (1483, 0, 'config', 'config_shared', '0', 0);
INSERT INTO `oc_setting` VALUES (1484, 0, 'config', 'config_encryption', '', 0);
INSERT INTO `oc_setting` VALUES (1492, 0, 'google_captcha', 'google_captcha_secret', '6LfKFycTAAAAAMYUAhcVrCS0--yY21l68-9DUmrP', 0);
...
INSERT INTO `oc_setting` VALUES (1463, 0, 'config', 'config_ftp_hostname', 'expigo.com', 0);
INSERT INTO `oc_setting` VALUES (1464, 0, 'config', 'config_ftp_port', '21', 0);
INSERT INTO `oc_setting` VALUES (1465, 0, 'config', 'config_ftp_username', '', 0);
INSERT INTO `oc_setting` VALUES (1466, 0, 'config', 'config_ftp_password', '', 0);
INSERT INTO `oc_setting` VALUES (1467, 0, 'config', 'config_ftp_root', '', 0);
INSERT INTO `oc_setting` VALUES (1468, 0, 'config', 'config_ftp_status', '0', 0);
INSERT INTO `oc_setting` VALUES (1469, 0, 'config', 'config_mail_protocol', 'mail', 0);
INSERT INTO `oc_setting` VALUES (1470, 0, 'config', 'config_mail_parameter', '', 0);
INSERT INTO `oc_setting` VALUES (1471, 0, 'config', 'config_mail_smtp_hostname', '', 0);
INSERT INTO `oc_setting` VALUES (1472, 0, 'config', 'config_mail_smtp_username', '', 0);
INSERT INTO `oc_setting` VALUES (1473, 0, 'config', 'config_mail_smtp_password', '', 0);
INSERT INTO `oc_setting` VALUES (1474, 0, 'config', 'config_mail_smtp_port', '25', 0);
INSERT INTO `oc_setting` VALUES (1475, 0, 'config', 'config_mail_smtp_timeout', '5', 0);
INSERT INTO `oc_setting` VALUES (1476, 0, 'config', 'config_mail_alert', '', 0);
INSERT INTO `oc_setting` VALUES (1477, 0, 'config', 'config_maintenance', '0', 0);
INSERT INTO `oc_setting` VALUES (1478, 0, 'config', 'config_seo_url', '0', 0);
INSERT INTO `oc_setting` VALUES (1479, 0, 'config', 'config_robots', 'abot\r\ndbot\r\nebot\r\nhbot\r\nkbot\r\nlbot\r\nmbot\r\nnbot\r\nobot\r\npbot\r\nrbot\r\nsbot\r\ntbot\r\nvbot\r\nybot\r\nzbot\r\nbot.\r\nbot/\r\n_bot\r\n.bot\r\n/bot\r\n-bot\r\n:bot\r\n(bot\r\ncrawl\r\nslurp\r\nspider\r\nseek\r\naccoona\r\nacoon\r\nadressendeutschland\r\nah-ha.com\r\nahoy\r\naltavista\r\nananzi\r\nanthill\r\nappie\r\narachnophilia\r\narale\r\naraneo\r\naranha\r\narchitext\r\naretha\r\narks\r\nasterias\r\natlocal\r\natn\r\natomz\r\naugurfind\r\nbackrub\r\nbannana_bot\r\nbaypup\r\nbdfetch\r\nbig brother\r\nbiglotron\r\nbjaaland\r\nblackwidow\r\nblaiz\r\nblog\r\nblo.\r\nbloodhound\r\nboitho\r\nbooch\r\nbradley\r\nbutterfly\r\ncalif\r\ncassandra\r\nccubee\r\ncfetch\r\ncharlotte\r\nchurl\r\ncienciaficcion\r\ncmc\r\ncollective\r\ncomagent\r\ncombine\r\ncomputingsite\r\ncsci\r\ncurl\r\ncusco\r\ndaumoa\r\ndeepindex\r\ndelorie\r\ndepspid\r\ndeweb\r\ndie blinde kuh\r\ndigger\r\nditto\r\ndmoz\r\ndocomo\r\ndownload express\r\ndtaagent\r\ndwcp\r\nebiness\r\nebingbong\r\ne-collector\r\nejupiter\r\nemacs-w3 search engine\r\nesther\r\nevliya celebi\r\nezresult\r\nfalcon\r\nfelix ide\r\nferret\r\nfetchrover\r\nfido\r\nfindlinks\r\nfireball\r\nfish search\r\nfouineur\r\nfunnelweb\r\ngazz\r\ngcreep\r\ngenieknows\r\ngetterroboplus\r\ngeturl\r\nglx\r\ngoforit\r\ngolem\r\ngrabber\r\ngrapnel\r\ngralon\r\ngriffon\r\ngromit\r\ngrub\r\ngulliver\r\nhamahakki\r\nharvest\r\nhavindex\r\nhelix\r\nheritrix\r\nhku www octopus\r\nhomerweb\r\nhtdig\r\nhtml index\r\nhtml_analyzer\r\nhtmlgobble\r\nhubater\r\nhyper-decontextualizer\r\nia_archiver\r\nibm_planetwide\r\nichiro\r\niconsurf\r\niltrovatore\r\nimage.kapsi.net\r\nimagelock\r\nincywincy\r\nindexer\r\ninfobee\r\ninformant\r\ningrid\r\ninktomisearch.com\r\ninspector web\r\nintelliagent\r\ninternet shinchakubin\r\nip3000\r\niron33\r\nisraeli-search\r\nivia\r\njack\r\njakarta\r\njavabee\r\njetbot\r\njumpstation\r\nkatipo\r\nkdd-explorer\r\nkilroy\r\nknowledge\r\nkototoi\r\nkretrieve\r\nlabelgrabber\r\nlachesis\r\nlarbin\r\nlegs\r\nlibwww\r\nlinkalarm\r\nlink validator\r\nlinkscan\r\nlockon\r\nlwp\r\nlycos\r\nmagpie\r\nmantraagent\r\nmapoftheinternet\r\nmarvin/\r\nmattie\r\nmediafox\r\nmediapartners\r\nmercator\r\nmerzscope\r\nmicrosoft url control\r\nminirank\r\nmiva\r\nmj12\r\nmnogosearch\r\nmoget\r\nmonster\r\nmoose\r\nmotor\r\nmultitext\r\nmuncher\r\nmuscatferret\r\nmwd.search\r\nmyweb\r\nnajdi\r\nnameprotect\r\nnationaldirectory\r\nnazilla\r\nncsa beta\r\nnec-meshexplorer\r\nnederland.zoek\r\nnetcarta webmap engine\r\nnetmechanic\r\nnetresearchserver\r\nnetscoop\r\nnewscan-online\r\nnhse\r\nnokia6682/\r\nnomad\r\nnoyona\r\nnutch\r\nnzexplorer\r\nobjectssearch\r\noccam\r\nomni\r\nopen text\r\nopenfind\r\nopenintelligencedata\r\norb search\r\nosis-project\r\npack rat\r\npageboy\r\npagebull\r\npage_verifier\r\npanscient\r\nparasite\r\npartnersite\r\npatric\r\npear.\r\npegasus\r\nperegrinator\r\npgp key agent\r\nphantom\r\nphpdig\r\npicosearch\r\npiltdownman\r\npimptrain\r\npinpoint\r\npioneer\r\npiranha\r\nplumtreewebaccessor\r\npogodak\r\npoirot\r\npompos\r\npoppelsdorf\r\npoppi\r\npopular iconoclast\r\npsycheclone\r\npublisher\r\npython\r\nrambler\r\nraven search\r\nroach\r\nroad runner\r\nroadhouse\r\nrobbie\r\nrobofox\r\nrobozilla\r\nrules\r\nsalty\r\nsbider\r\nscooter\r\nscoutjet\r\nscrubby\r\nsearch.\r\nsearchprocess\r\nsemanticdiscovery\r\nsenrigan\r\nsg-scout\r\nshai''hulud\r\nshark\r\nshopwiki\r\nsidewinder\r\nsift\r\nsilk\r\nsimmany\r\nsite searcher\r\nsite valet\r\nsitetech-rover\r\nskymob.com\r\nsleek\r\nsmartwit\r\nsna-\r\nsnappy\r\nsnooper\r\nsohu\r\nspeedfind\r\nsphere\r\nsphider\r\nspinner\r\nspyder\r\nsteeler/\r\nsuke\r\nsuntek\r\nsupersnooper\r\nsurfnomore\r\nsven\r\nsygol\r\nszukacz\r\ntach black widow\r\ntarantula\r\ntempleton\r\n/teoma\r\nt-h-u-n-d-e-r-s-t-o-n-e\r\ntheophrastus\r\ntitan\r\ntitin\r\ntkwww\r\ntoutatis\r\nt-rex\r\ntutorgig\r\ntwiceler\r\ntwisted\r\nucsd\r\nudmsearch\r\nurl check\r\nupdated\r\nvagabondo\r\nvalkyrie\r\nverticrawl\r\nvictoria\r\nvision-search\r\nvolcano\r\nvoyager/\r\nvoyager-hc\r\nw3c_validator\r\nw3m2\r\nw3mir\r\nwalker\r\nwallpaper\r\nwanderer\r\nwauuu\r\nwavefire\r\nweb core\r\nweb hopper\r\nweb wombat\r\nwebbandit\r\nwebcatcher\r\nwebcopy\r\nwebfoot\r\nweblayers\r\nweblinker\r\nweblog monitor\r\nwebmirror\r\nwebmonkey\r\nwebquest\r\nwebreaper\r\nwebsitepulse\r\nwebsnarf\r\nwebstolperer\r\nwebvac\r\nwebwalk\r\nwebwatch\r\nwebwombat\r\nwebzinger\r\nwhizbang\r\nwhowhere\r\nwild ferret\r\nworldlight\r\nwwwc\r\nwwwster\r\nxenu\r\nxget\r\nxift\r\nxirq\r\nyandex\r\nyanga\r\nyeti\r\nyodao\r\nzao\r\nzippp\r\nzyborg', 0);
INSERT INTO `oc_setting` VALUES (1462, 0, 'config', 'config_icon', 'catalog/cart.png', 0);
INSERT INTO `oc_setting` VALUES (1461, 0, 'config', 'config_logo', 'catalog/logo_Expigo.png', 0);
INSERT INTO `oc_setting` VALUES (1460, 0, 'config', 'config_captcha_page', '["review","return","contact"]', 1);
INSERT INTO `oc_setting` VALUES (1459, 0, 'config', 'config_captcha', '', 0);
INSERT INTO `oc_setting` VALUES (1458, 0, 'config', 'config_return_status_id', '2', 0);
INSERT INTO `oc_setting` VALUES (1457, 0, 'config', 'config_return_id', '0', 0);
INSERT INTO `oc_setting` VALUES (1456, 0, 'config', 'config_affiliate_mail', '0', 0);
INSERT INTO `oc_setting` VALUES (1455, 0, 'config', 'config_affiliate_id', '4', 0);
INSERT INTO `oc_setting` VALUES (1454, 0, 'config', 'config_affiliate_commission', '5', 0);
INSERT INTO `oc_setting` VALUES (1453, 0, 'config', 'config_affiliate_auto', '0', 0);
INSERT INTO `oc_setting` VALUES (1452, 0, 'config', 'config_affiliate_approval', '0', 0);
INSERT INTO `oc_setting` VALUES (1451, 0, 'config', 'config_stock_checkout', '0', 0);
INSERT INTO `oc_setting` VALUES (1450, 0, 'config', 'config_stock_warning', '0', 0);
INSERT INTO `oc_setting` VALUES (1449, 0, 'config', 'config_stock_display', '0', 0);
INSERT INTO `oc_setting` VALUES (1448, 0, 'config', 'config_api_id', '1', 0);
...
INSERT INTO `oc_setting` VALUES (292, 0, 'theme_default', 'theme_default_image_thumb_width', '400', 0);
INSERT INTO `oc_setting` VALUES (293, 0, 'theme_default', 'theme_default_image_thumb_height', '400', 0);
...
INSERT INTO `oc_setting` VALUES (296, 0, 'theme_default', 'theme_default_image_category_width', '200', 0);
INSERT INTO `oc_setting` VALUES (297, 0, 'theme_default', 'theme_default_image_category_height', '200', 0);
INSERT INTO `oc_setting` VALUES (298, 0, 'theme_default', 'theme_default_image_product_width', '200', 0);
INSERT INTO `oc_setting` VALUES (299, 0, 'theme_default', 'theme_default_image_product_height', '200', 0);
...
INSERT INTO `oc_setting` VALUES (312, 0, 'theme_default', 'theme_default_directory', 'themegloballite', 0);
INSERT INTO `oc_setting` VALUES (313, 0, 'theme_default', 'theme_default_status', '1', 0);
INSERT INTO `oc_setting` VALUES (1447, 0, 'config', 'config_order_mail', '0', 0);
INSERT INTO `oc_setting` VALUES (1446, 0, 'config', 'config_fraud_status_id', '7', 0);
INSERT INTO `oc_setting` VALUES (1444, 0, 'config', 'config_processing_status', '["5","1","2","12","3"]', 1);
INSERT INTO `oc_setting` VALUES (1445, 0, 'config', 'config_complete_status', '["5","3"]', 1);
INSERT INTO `oc_setting` VALUES (1443, 0, 'config', 'config_order_status_id', '1', 0);
INSERT INTO `oc_setting` VALUES (1442, 0, 'config', 'config_checkout_id', '5', 0);
INSERT INTO `oc_setting` VALUES (1441, 0, 'config', 'config_checkout_guest', '0', 0);
INSERT INTO `oc_setting` VALUES (1440, 0, 'config', 'config_cart_weight', '1', 0);
INSERT INTO `oc_setting` VALUES (1439, 0, 'config', 'config_invoice_prefix', 'INV-2016-00', 0);
INSERT INTO `oc_setting` VALUES (1436, 0, 'config', 'config_login_attempts', '5', 0);
INSERT INTO `oc_setting` VALUES (1437, 0, 'config', 'config_account_id', '3', 0);
INSERT INTO `oc_setting` VALUES (1438, 0, 'config', 'config_account_mail', '0', 0);
INSERT INTO `oc_setting` VALUES (1434, 0, 'config', 'config_customer_group_display', '["1"]', 1);
INSERT INTO `oc_setting` VALUES (1435, 0, 'config', 'config_customer_price', '0', 0);
INSERT INTO `oc_setting` VALUES (1433, 0, 'config', 'config_customer_group_id', '1', 0);
INSERT INTO `oc_setting` VALUES (1432, 0, 'config', 'config_customer_online', '0', 0);
INSERT INTO `oc_setting` VALUES (1431, 0, 'config', 'config_tax_customer', 'shipping', 0);
INSERT INTO `oc_setting` VALUES (318, 0, 'themegloballite_skin', 'themegloballite_skin', 'tglite_default', 0);
INSERT INTO `oc_setting` VALUES (319, 0, 'tg_tglite_revolution_slider', 'tg_tglite_revolution_slider_module', '[{"slider_id":"2","layout_id":"1","position":"slideshow","sort_order":"0","status":"1"}]', 1);
INSERT INTO `oc_setting` VALUES (320, 0, 'information', 'information_status', '1', 0);
INSERT INTO `oc_setting` VALUES (1430, 0, 'config', 'config_tax_default', 'shipping', 0);
INSERT INTO `oc_setting` VALUES (1429, 0, 'config', 'config_tax', '1', 0);
INSERT INTO `oc_setting` VALUES (1428, 0, 'config', 'config_voucher_max', '1000', 0);
INSERT INTO `oc_setting` VALUES (1427, 0, 'config', 'config_voucher_min', '1', 0);
INSERT INTO `oc_setting` VALUES (1426, 0, 'config', 'config_review_mail', '0', 0);
INSERT INTO `oc_setting` VALUES (1425, 0, 'config', 'config_review_guest', '1', 0);
INSERT INTO `oc_setting` VALUES (1424, 0, 'config', 'config_review_status', '1', 0);
INSERT INTO `oc_setting` VALUES (1423, 0, 'config', 'config_limit_admin', '20', 0);
INSERT INTO `oc_setting` VALUES (1422, 0, 'config', 'config_product_count', '1', 0);
INSERT INTO `oc_setting` VALUES (1421, 0, 'config', 'config_weight_class_id', '1', 0);
INSERT INTO `oc_setting` VALUES (1420, 0, 'config', 'config_length_class_id', '1', 0);
INSERT INTO `oc_setting` VALUES (1419, 0, 'config', 'config_currency_auto', '1', 0);
INSERT INTO `oc_setting` VALUES (1418, 0, 'config', 'config_currency', 'USD', 0);
INSERT INTO `oc_setting` VALUES (1417, 0, 'config', 'config_admin_language', 'es-es', 0);
INSERT INTO `oc_setting` VALUES (1416, 0, 'config', 'config_language', 'en-gb', 0);
INSERT INTO `oc_setting` VALUES (1415, 0, 'config', 'config_zone_id', '988', 0);
INSERT INTO `oc_setting` VALUES (1414, 0, 'config', 'config_country_id', '62', 0);
INSERT INTO `oc_setting` VALUES (1413, 0, 'config', 'config_comment', '', 0);
INSERT INTO `oc_setting` VALUES (1412, 0, 'config', 'config_open', '', 0);
INSERT INTO `oc_setting` VALUES (1411, 0, 'config', 'config_image', 'catalog/logo_Expigo.png', 0);
INSERT INTO `oc_setting` VALUES (1410, 0, 'config', 'config_fax', '', 0);
INSERT INTO `oc_setting` VALUES (1407, 0, 'config', 'config_geocode', '', 0);
INSERT INTO `oc_setting` VALUES (1408, 0, 'config', 'config_email', 'yamil@skysite.com.ec', 0);
INSERT INTO `oc_setting` VALUES (1409, 0, 'config', 'config_telephone', '123456789', 0);
INSERT INTO `oc_setting` VALUES (1406, 0, 'config', 'config_address', 'Address 1', 0);
INSERT INTO `oc_setting` VALUES (1405, 0, 'config', 'config_owner', 'Your Name', 0);
INSERT INTO `oc_setting` VALUES (1404, 0, 'config', 'config_name', 'Expigo', 0);
INSERT INTO `oc_setting` VALUES (1403, 0, 'config', 'config_layout_id', '4', 0);
INSERT INTO `oc_setting` VALUES (1402, 0, 'config', 'config_theme', 'theme_default', 0);
INSERT INTO `oc_setting` VALUES (1401, 0, 'config', 'config_meta_keyword', '', 0);
INSERT INTO `oc_setting` VALUES (1400, 0, 'config', 'config_meta_description', 'Distribuidora de café', 0);
INSERT INTO `oc_setting` VALUES (1399, 0, 'config', 'config_meta_title', 'Expigo', 0);
INSERT INTO `oc_setting` VALUES (1306, 0, 'pp_button', 'pp_button_status', '0', 0);
INSERT INTO `oc_setting` VALUES (1243, 0, 'bank_transfer', 'bank_transfer_bank2', 'Instrucciones', 0);
INSERT INTO `oc_setting` VALUES (1244, 0, 'bank_transfer', 'bank_transfer_bank1', 'Instructions', 0);
INSERT INTO `oc_setting` VALUES (1245, 0, 'bank_transfer', 'bank_transfer_total', '', 0);
INSERT INTO `oc_setting` VALUES (1246, 0, 'bank_transfer', 'bank_transfer_order_status_id', '7', 0);
INSERT INTO `oc_setting` VALUES (1247, 0, 'bank_transfer', 'bank_transfer_geo_zone_id', '0', 0);
INSERT INTO `oc_setting` VALUES (1248, 0, 'bank_transfer', 'bank_transfer_status', '1', 0);
INSERT INTO `oc_setting` VALUES (1249, 0, 'bank_transfer', 'bank_transfer_sort_order', '', 0);
INSERT INTO `oc_setting` VALUES (1298, 0, 'pp_express', 'pp_express_pending_status_id', '1', 0);
INSERT INTO `oc_setting` VALUES (1297, 0, 'pp_express', 'pp_express_failed_status_id', '10', 0);
INSERT INTO `oc_setting` VALUES (1296, 0, 'pp_express', 'pp_express_expired_status_id', '14', 0);
INSERT INTO `oc_setting` VALUES (1295, 0, 'pp_express', 'pp_express_denied_status_id', '8', 0);
INSERT INTO `oc_setting` VALUES (1294, 0, 'pp_express', 'pp_express_completed_status_id', '5', 0);
INSERT INTO `oc_setting` VALUES (1293, 0, 'pp_express', 'pp_express_canceled_reversal_status_id', '7', 0);
INSERT INTO `oc_setting` VALUES (1292, 0, 'pp_express', 'pp_express_sort_order', '', 0);
INSERT INTO `oc_setting` VALUES (1291, 0, 'pp_express', 'pp_express_status', '1', 0);
INSERT INTO `oc_setting` VALUES (1290, 0, 'pp_express', 'pp_express_geo_zone_id', '0', 0);
INSERT INTO `oc_setting` VALUES (1289, 0, 'pp_express', 'pp_express_total', '', 0);
INSERT INTO `oc_setting` VALUES (1288, 0, 'pp_express', 'pp_express_transaction', 'Sale', 0);
INSERT INTO `oc_setting` VALUES (1287, 0, 'pp_express', 'pp_express_recurring_cancel', '0', 0);
INSERT INTO `oc_setting` VALUES (1286, 0, 'pp_express', 'pp_express_currency', 'USD', 0);
INSERT INTO `oc_setting` VALUES (1285, 0, 'pp_express', 'pp_express_debug', '0', 0);
INSERT INTO `oc_setting` VALUES (1284, 0, 'pp_express', 'pp_express_test', '0', 0);
INSERT INTO `oc_setting` VALUES (1283, 0, 'pp_express', 'pp_express_sandbox_signature', '', 0);
INSERT INTO `oc_setting` VALUES (1282, 0, 'pp_express', 'pp_express_sandbox_password', '', 0);
INSERT INTO `oc_setting` VALUES (1281, 0, 'pp_express', 'pp_express_sandbox_username', '', 0);
INSERT INTO `oc_setting` VALUES (1280, 0, 'pp_express', 'pp_express_signature', 'ApX2FFx1mlnXv82RWCHKYiENoF7DAfVdodezBhGRzojEJJ9h4Na7elY4', 0);
INSERT INTO `oc_setting` VALUES (1279, 0, 'pp_express', 'pp_express_password', '8NX3US9YPJU3KCNS', 0);
INSERT INTO `oc_setting` VALUES (1278, 0, 'pp_express', 'pp_express_username', 'yamil.nunez_api1.gmail.com', 0);
INSERT INTO `oc_setting` VALUES (1299, 0, 'pp_express', 'pp_express_processed_status_id', '15', 0);
INSERT INTO `oc_setting` VALUES (1300, 0, 'pp_express', 'pp_express_refunded_status_id', '11', 0);
INSERT INTO `oc_setting` VALUES (1301, 0, 'pp_express', 'pp_express_reversed_status_id', '12', 0);
INSERT INTO `oc_setting` VALUES (1302, 0, 'pp_express', 'pp_express_voided_status_id', '16', 0);
INSERT INTO `oc_setting` VALUES (1303, 0, 'pp_express', 'pp_express_allow_note', '0', 0);
INSERT INTO `oc_setting` VALUES (1304, 0, 'pp_express', 'pp_express_colour', '', 0);
INSERT INTO `oc_setting` VALUES (1305, 0, 'pp_express', 'pp_express_logo', '', 0);
...
-- 
-- Volcar la base de datos para la tabla `oc_stock_status`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_store`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_tax_class`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_tax_rate`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_tax_rate_to_customer_group`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_tax_rule`
-- 
...
-- 
-- Estructura de tabla para la tabla `oc_tg_tglite_revolution_slider`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_tg_tglite_revolution_slider`
-- 

INSERT INTO `oc_tg_tglite_revolution_slider` VALUES (2, 'Coffe Slider', 'a:4:{s:12:"slider_width";s:4:"1290";s:13:"slider_height";s:3:"500";s:12:"slider_speed";s:2:"12";s:11:"layout_type";s:1:"0";}', 'a:3:{i:1;a:2:{i:2;a:4:{s:6:"status";s:1:"0";s:6:"slider";s:0:"";s:17:"transition_effect";s:8:"boxslide";s:4:"link";s:0:"";}i:1;a:5:{s:6:"status";s:1:"0";s:6:"slider";s:34:"catalog/themegloballite/slide3.jpg";s:17:"transition_effect";s:6:"random";s:4:"link";s:0:"";s:8:"elements";a:20:{i:1;a:15:{s:6:"status";s:1:"1";s:12:"element_type";s:5:"image";s:5:"image";s:38:"catalog/themegloballite/tg-subimg0.png";s:9:"image_url";s:0:"";s:17:"image_url_new_tab";s:1:"0";s:4:"text";s:0:"";s:13:"element_class";s:0:"";s:5:"style";s:0:"";s:15:"animation_class";s:3:"sft";s:6:"easing";s:11:"easeOutBack";s:9:"endeasing";s:11:"easeOutBack";s:5:"speed";s:4:"1000";s:5:"start";s:3:"500";s:1:"x";s:2:"50";s:1:"y";s:3:"390";}i:2;a:15:{s:6:"status";s:1:"1";s:12:"element_type";s:5:"image";s:5:"image";s:39:"catalog/themegloballite/tg-subimg11.png";s:9:"image_url";s:0:"";s:17:"image_url_new_tab";s:1:"0";s:4:"text";s:0:"";s:13:"element_class";s:0:"";s:5:"style";s:0:"";s:15:"animation_class";s:3:"sft";s:6:"easing";s:11:"easeOutBack";s:9:"endeasing";s:11:"easeOutBack";s:5:"speed";s:4:"1500";s:5:"start";s:4:"2500";s:1:"x";s:3:"570";s:1:"y";s:3:"290";}i:3;a:15:{s:6:"status";s:1:"1";s:12:"element_type";s:5:"image";s:5:"image";s:39:"catalog/themegloballite/tg-subimg11.png";s:9:"image_url";s:0:"";s:17:"image_url_new_tab";s:1:"0";s:4:"text";s:0:"";s:13:"element_class";s:0:"";s:5:"style";s:0:"";s:15:"animation_class";s:3:"sft";s:6:"easing";s:11:"easeOutBack";s:9:"endeasing";s:11:"easeOutBack";s:5:"speed";s:4:"1500";s:5:"start";s:4:"2500";s:1:"x";s:3:"175";s:1:"y";s:3:"290";}i:4;a:15:{s:6:"status";s:1:"1";s:12:"element_type";s:5:"image";s:5:"image";s:39:"catalog/themegloballite/tg-subimg12.png";s:9:"image_url";s:0:"";s:17:"image_url_new_tab";s:1:"0";s:4:"text";s:0:"";s:13:"element_class";s:0:"";s:5:"style";s:0:"";s:15:"animation_class";s:3:"sft";s:6:"easing";s:11:"easeOutBack";s:9:"endeasing";s:11:"easeOutBack";s:5:"speed";s:4:"1500";s:5:"start";s:4:"3000";s:1:"x";s:3:"580";s:1:"y";s:2:"90";}i:5;a:15:{s:6:"status";s:1:"1";s:12:"element_type";s:5:"image";s:5:"image";s:39:"catalog/themegloballite/tg-subimg13.png";s:9:"image_url";s:0:"";s:17:"image_url_new_tab";s:1:"0";s:4:"text";s:0:"";s:13:"element_class";s:0:"";s:5:"style";s:0:"";s:15:"animation_class";s:3:"sft";s:6:"easing";s:11:"easeOutBack";s:9:"endeasing";s:11:"easeOutBack";s:5:"speed";s:4:"1500";s:5:"start";s:4:"3500";s:1:"x";s:3:"250";s:1:"y";s:3:"185";}i:6;a:15:{s:6:"status";s:1:"1";s:12:"element_type";s:5:"image";s:5:"image";s:38:"catalog/themegloballite/tg-subimg2.png";s:9:"image_url";s:0:"";s:17:"image_url_new_tab";s:1:"0";s:4:"text";s:0:"";s:13:"element_class";s:0:"";s:5:"style";s:0:"";s:15:"animation_class";s:3:"sft";s:6:"easing";s:11:"easeOutBack";s:9:"endeasing";s:11:"easeOutBack";s:5:"speed";s:4:"1500";s:5:"start";s:4:"4000";s:1:"x";s:3:"261";s:1:"y";s:2:"81";}i:7;a:15:{s:6:"status";s:1:"1";s:12:"element_type";s:5:"image";s:5:"image";s:38:"catalog/themegloballite/tg-subimg5.png";s:9:"image_url";s:0:"";s:17:"image_url_new_tab";s:1:"0";s:4:"text";s:0:"";s:13:"element_class";s:0:"";s:5:"style";s:0:"";s:15:"animation_class";s:3:"lfl";s:6:"easing";s:11:"easeOutBack";s:9:"endeasing";s:11:"easeOutBack";s:5:"speed";s:4:"1500";s:5:"start";s:4:"4000";s:1:"x";s:3:"460";s:1:"y";s:3:"100";}i:8;a:15:{s:6:"status";s:1:"1";s:12:"element_type";s:5:"image";s:5:"image";s:38:"catalog/themegloballite/tg-subimg3.png";s:9:"image_url";s:0:"";s:17:"image_url_new_tab";s:1:"0";s:4:"text";s:0:"";s:13:"element_class";s:0:"";s:5:"style";s:0:"";s:15:"animation_class";s:3:"sfl";s:6:"easing";s:11:"easeOutBack";s:9:"endeasing";s:11:"easeOutBack";s:5:"speed";s:4:"1500";s:5:"start";s:4:"4500";s:1:"x";s:3:"630";s:1:"y";s:3:"196";}i:9;a:15:{s:6:"status";s:1:"1";s:12:"element_type";s:5:"image";s:5:"image";s:38:"catalog/themegloballite/tg-subimg4.png";s:9:"image_url";s:0:"";s:17:"image_url_new_tab";s:1:"0";s:4:"text";s:0:"";s:13:"element_class";s:0:"";s:5:"style";s:0:"";s:15:"animation_class";s:3:"sfr";s:6:"easing";s:11:"easeOutBack";s:9:"endeasing";s:11:"easeOutBack";s:5:"speed";s:4:"1500";s:5:"start";s:4:"5500";s:1:"x";s:2:"75";s:1:"y";s:3:"154";}i:10;a:15:{s:6:"status";s:1:"1";s:12:"element_type";s:5:"image";s:5:"image";s:38:"catalog/themegloballite/tg-subimg6.png";s:9:"image_url";s:0:"";s:17:"image_url_new_tab";s:1:"0";s:4:"text";s:0:"";s:13:"element_class";s:0:"";s:5:"style";s:0:"";s:15:"animation_class";s:3:"lfb";s:6:"easing";s:11:"easeOutBack";s:9:"endeasing";s:11:"easeOutBack";s:5:"speed";s:4:"1500";s:5:"start";s:4:"6000";s:1:"x";s:3:"220";s:1:"y";s:3:"316";}i:11;a:15:{s:6:"status";s:1:"1";s:12:"element_type";s:5:"image";s:5:"image";s:38:"catalog/themegloballite/tg-subimg7.png";s:9:"image_url";s:0:"";s:17:"image_url_new_tab";s:1:"0";s:4:"text";s:0:"";s:13:"element_class";s:0:"";s:5:"style";s:0:"";s:15:"animation_class";s:3:"sfb";s:6:"easing";s:11:"easeOutBack";s:9:"endeasing";s:11:"easeOutBack";s:5:"speed";s:4:"2000";s:5:"start";s:4:"7000";s:1:"x";s:3:"520";s:1:"y";s:3:"375";}i:12;a:15:{s:6:"status";s:1:"1";s:12:"element_type";s:5:"image";s:5:"image";s:38:"catalog/themegloballite/tg-subimg8.png";s:9:"image_url";s:0:"";s:17:"image_url_new_tab";s:1:"0";s:4:"text";s:0:"";s:13:"element_class";s:0:"";s:5:"style";s:0:"";s:15:"animation_class";s:3:"sfb";s:6:"easing";s:11:"easeOutBack";s:9:"endeasing";s:11:"easeOutBack";s:5:"speed";s:4:"2000";s:5:"start";s:4:"8000";s:1:"x";s:3:"305";s:1:"y";s:3:"355";}i:13;a:15:{s:6:"status";s:1:"1";s:12:"element_type";s:5:"image";s:5:"image";s:38:"catalog/themegloballite/tg-subimg9.png";s:9:"image_url";s:0:"";s:17:"image_url_new_tab";s:1:"0";s:4:"text";s:0:"";s:13:"element_class";s:0:"";s:5:"style";s:0:"";s:15:"animation_class";s:3:"sfb";s:6:"easing";s:11:"easeOutBack";s:9:"endeasing";s:11:"easeOutBack";s:5:"speed";s:4:"2000";s:5:"start";s:4:"8300";s:1:"x";s:3:"340";s:1:"y";s:3:"360";}i:14;a:15:{s:6:"status";s:1:"1";s:12:"element_type";s:5:"image";s:5:"image";s:39:"catalog/themegloballite/tg-subimg10.png";s:9:"image_url";s:0:"";s:17:"image_url_new_tab";s:1:"0";s:4:"text";s:0:"";s:13:"element_class";s:0:"";s:5:"style";s:0:"";s:15:"animation_class";s:3:"sfb";s:6:"easing";s:11:"easeOutBack";s:9:"endeasing";s:11:"easeOutBack";s:5:"speed";s:4:"2000";s:5:"start";s:4:"8800";s:1:"x";s:3:"475";s:1:"y";s:3:"355";}i:15;a:15:{s:6:"status";s:1:"1";s:12:"element_type";s:4:"html";s:5:"image";s:0:"";s:9:"image_url";s:0:"";s:17:"image_url_new_tab";s:1:"0";s:4:"text";s:17:"ThemeGlobal Lite ";s:13:"element_class";s:16:"new_element_1_16";s:5:"style";s:77:".new_element_1_16 {font-size: 40px;text-transform: uppercase;color: #FFFFFF;}";s:15:"animation_class";s:3:"sfr";s:6:"easing";s:11:"easeOutBack";s:9:"endeasing";s:11:"easeOutBack";s:5:"speed";s:4:"2000";s:5:"start";s:5:"10000";s:1:"x";s:3:"775";s:1:"y";s:3:"110";}i:16;a:15:{s:6:"status";s:1:"1";s:12:"element_type";s:4:"html";s:5:"image";s:0:"";s:9:"image_url";s:0:"";s:17:"image_url_new_tab";s:1:"0";s:4:"text";s:55:"The best responsive 100% FREE OpenCart 2.0 theme ever. ";s:13:"element_class";s:16:"new_element_1_17";s:5:"style";s:71:".new_element_1_17 {font-size: 16px;color: #FFFFFF;font-weight: normal;}";s:15:"animation_class";s:3:"sfr";s:6:"easing";s:11:"easeOutBack";s:9:"endeasing";s:11:"easeOutBack";s:5:"speed";s:4:"2000";s:5:"start";s:5:"10000";s:1:"x";s:3:"775";s:1:"y";s:3:"190";}i:17;a:15:{s:6:"status";s:1:"1";s:12:"element_type";s:4:"html";s:5:"image";s:0:"";s:9:"image_url";s:0:"";s:17:"image_url_new_tab";s:1:"0";s:4:"text";s:56:"Powerful Admin - endless customizition possibility, with";s:13:"element_class";s:16:"new_element_1_18";s:5:"style";s:71:".new_element_1_18 {font-size: 16px;color: #FFFFFF;font-weight: normal;}";s:15:"animation_class";s:3:"sfr";s:6:"easing";s:11:"easeOutBack";s:9:"endeasing";s:11:"easeOutBack";s:5:"speed";s:4:"2000";s:5:"start";s:5:"10000";s:1:"x";s:3:"775";s:1:"y";s:3:"220";}i:18;a:15:{s:6:"status";s:1:"1";s:12:"element_type";s:4:"html";s:5:"image";s:0:"";s:9:"image_url";s:0:"";s:17:"image_url_new_tab";s:1:"0";s:4:"text";s:55:"skin saving. Revolution Slider - you can add unlimited ";s:13:"element_class";s:16:"new_element_1_19";s:5:"style";s:71:".new_element_1_19 {font-size: 16px;color: #FFFFFF;font-weight: normal;}";s:15:"animation_class";s:3:"sfr";s:6:"easing";s:11:"easeOutBack";s:9:"endeasing";s:11:"easeOutBack";s:5:"speed";s:4:"2000";s:5:"start";s:5:"10000";s:1:"x";s:3:"775";s:1:"y";s:3:"250";}i:19;a:15:{s:6:"status";s:1:"1";s:12:"element_type";s:4:"html";s:5:"image";s:0:"";s:9:"image_url";s:0:"";s:17:"image_url_new_tab";s:1:"0";s:4:"text";s:56:"slides and sub-slides. Easy to install with sample data.";s:13:"element_class";s:16:"new_element_1_20";s:5:"style";s:71:".new_element_1_20 {font-size: 16px;color: #FFFFFF;font-weight: normal;}";s:15:"animation_class";s:3:"sfr";s:6:"easing";s:11:"easeOutBack";s:9:"endeasing";s:11:"easeOutBack";s:5:"speed";s:4:"2000";s:5:"start";s:5:"10000";s:1:"x";s:3:"775";s:1:"y";s:3:"280";}i:20;a:15:{s:6:"status";s:1:"1";s:12:"element_type";s:5:"image";s:5:"image";s:36:"catalog/themegloballite/readmore.png";s:9:"image_url";s:22:"http://themeglobal.com";s:17:"image_url_new_tab";s:1:"0";s:4:"text";s:0:"";s:13:"element_class";s:0:"";s:5:"style";s:0:"";s:15:"animation_class";s:3:"sfr";s:6:"easing";s:11:"easeOutBack";s:9:"endeasing";s:11:"easeOutBack";s:5:"speed";s:4:"2000";s:5:"start";s:5:"10000";s:1:"x";s:3:"775";s:1:"y";s:3:"340";}}}}i:2;a:2:{i:2;a:4:{s:6:"status";s:1:"0";s:6:"slider";s:0:"";s:17:"transition_effect";s:8:"boxslide";s:4:"link";s:0:"";}i:1;a:5:{s:6:"status";s:1:"0";s:6:"slider";s:34:"catalog/themegloballite/slide2.jpg";s:17:"transition_effect";s:6:"random";s:4:"link";s:0:"";s:8:"elements";a:6:{i:1;a:15:{s:6:"status";s:1:"1";s:12:"element_type";s:5:"image";s:5:"image";s:39:"catalog/themegloballite/tg-sub2img1.png";s:9:"image_url";s:0:"";s:17:"image_url_new_tab";s:1:"0";s:4:"text";s:0:"";s:13:"element_class";s:0:"";s:5:"style";s:0:"";s:15:"animation_class";s:3:"lfb";s:6:"easing";s:11:"easeInQuart";s:9:"endeasing";s:10:"easeInBack";s:5:"speed";s:4:"2000";s:5:"start";s:3:"500";s:1:"x";s:3:"150";s:1:"y";s:2:"66";}i:2;a:15:{s:6:"status";s:1:"1";s:12:"element_type";s:4:"html";s:5:"image";s:0:"";s:9:"image_url";s:0:"";s:17:"image_url_new_tab";s:1:"0";s:4:"text";s:21:"100% Fully Responsive";s:13:"element_class";s:16:"new_element_2_23";s:5:"style";s:77:".new_element_2_23 {font-size: 40px;text-transform: uppercase;color: #FFFFFF;}";s:15:"animation_class";s:3:"lfr";s:6:"easing";s:11:"easeOutBack";s:9:"endeasing";s:11:"easeOutBack";s:5:"speed";s:4:"2000";s:5:"start";s:4:"2000";s:1:"x";s:3:"580";s:1:"y";s:3:"100";}i:3;a:15:{s:6:"status";s:1:"1";s:12:"element_type";s:4:"html";s:5:"image";s:0:"";s:9:"image_url";s:0:"";s:17:"image_url_new_tab";s:1:"0";s:4:"text";s:78:"Full functionality of your OpenCart store on all mobile devices is guaranteed.";s:13:"element_class";s:16:"new_element_2_24";s:5:"style";s:71:".new_element_2_24 {font-size: 16px;color: #FFFFFF;font-weight: normal;}";s:15:"animation_class";s:3:"lfr";s:6:"easing";s:11:"easeOutBack";s:9:"endeasing";s:11:"easeOutBack";s:5:"speed";s:4:"2000";s:5:"start";s:4:"3000";s:1:"x";s:3:"585";s:1:"y";s:3:"190";}i:4;a:15:{s:6:"status";s:1:"1";s:12:"element_type";s:4:"html";s:5:"image";s:0:"";s:9:"image_url";s:0:"";s:17:"image_url_new_tab";s:1:"0";s:4:"text";s:71:"Compatible with the latest desktop and mobile browsers. Works perfectly";s:13:"element_class";s:16:"new_element_2_25";s:5:"style";s:71:".new_element_2_25 {font-size: 16px;color: #FFFFFF;font-weight: normal;}";s:15:"animation_class";s:3:"lfr";s:6:"easing";s:11:"easeOutBack";s:9:"endeasing";s:11:"easeOutBack";s:5:"speed";s:4:"2000";s:5:"start";s:4:"3000";s:1:"x";s:3:"585";s:1:"y";s:3:"220";}i:5;a:15:{s:6:"status";s:1:"1";s:12:"element_type";s:4:"html";s:5:"image";s:0:"";s:9:"image_url";s:0:"";s:17:"image_url_new_tab";s:1:"0";s:4:"text";s:40:"wherever you need and wherever you want.";s:13:"element_class";s:16:"new_element_2_26";s:5:"style";s:70:".new_element_2_26{font-size: 16px;color: #FFFFFF;font-weight: normal;}";s:15:"animation_class";s:3:"lfr";s:6:"easing";s:11:"easeOutBack";s:9:"endeasing";s:11:"easeOutBack";s:5:"speed";s:4:"2000";s:5:"start";s:4:"3000";s:1:"x";s:3:"585";s:1:"y";s:3:"250";}i:6;a:15:{s:6:"status";s:1:"1";s:12:"element_type";s:5:"image";s:5:"image";s:36:"catalog/themegloballite/readmore.png";s:9:"image_url";s:22:"http://themeglobal.com";s:17:"image_url_new_tab";s:1:"0";s:4:"text";s:0:"";s:13:"element_class";s:0:"";s:5:"style";s:0:"";s:15:"animation_class";s:3:"lfb";s:6:"easing";s:11:"easeOutBack";s:9:"endeasing";s:11:"easeOutBack";s:5:"speed";s:4:"2000";s:5:"start";s:4:"4000";s:1:"x";s:3:"585";s:1:"y";s:3:"320";}}}}i:3;a:2:{i:2;a:5:{s:6:"status";s:1:"1";s:6:"slider";s:47:"catalog/Slider/banner4-coffee-cup-and-beans.jpg";s:17:"transition_effect";s:9:"curtain-1";s:4:"link";s:0:"";s:8:"elements";a:1:{i:1;a:15:{s:6:"status";s:1:"1";s:12:"element_type";s:4:"html";s:5:"image";s:0:"";s:9:"image_url";s:0:"";s:17:"image_url_new_tab";s:1:"0";s:4:"text";s:86:"&lt;p&gt;Cierra tus ojos y trata de oler la frescura de la brisa del océano&lt;/p&gt;";s:13:"element_class";s:11:"logo_banner";s:5:"style";s:409:"@import ''https://fonts.googleapis.com/css?family=Arima+Madurai'';\r\n\r\n.logo_banner {\r\n  text-transform: none !important;\r\n    color: #000;\r\n    max-width: 420px !important;\r\n    font-family: ''Poiret One'';\r\n    font-size: 40px !important;\r\n    color: #191919;\r\n    line-height: 1 !important;\r\n    white-space: inherit !important;\r\n}\r\n@media (max-width: 767px){\r\n.logo_banner {\r\n font-size: 23px !important;\r\n}\r\n}";s:15:"animation_class";s:3:"lfl";s:6:"easing";s:11:"easeOutBack";s:9:"endeasing";s:11:"easeOutBack";s:5:"speed";s:4:"2000";s:5:"start";s:3:"300";s:1:"x";s:3:"100";s:1:"y";s:3:"150";}}}i:1;a:5:{s:6:"status";s:1:"1";s:6:"slider";s:47:"catalog/Slider/banner4-coffee-cup-and-beans.jpg";s:17:"transition_effect";s:9:"curtain-1";s:4:"link";s:0:"";s:8:"elements";a:1:{i:1;a:15:{s:6:"status";s:1:"1";s:12:"element_type";s:4:"html";s:5:"image";s:0:"";s:9:"image_url";s:0:"";s:17:"image_url_new_tab";s:1:"0";s:4:"text";s:85:"&lt;p&gt;Close your eyes and try to smell the freshness of the ocean breeze&lt;/p&gt;";s:13:"element_class";s:11:"logo_banner";s:5:"style";s:409:"@import ''https://fonts.googleapis.com/css?family=Arima+Madurai'';\r\n\r\n.logo_banner {\r\n  text-transform: none !important;\r\n    color: #000;\r\n    max-width: 420px !important;\r\n    font-family: ''Poiret One'';\r\n    font-size: 40px !important;\r\n    color: #191919;\r\n    line-height: 1 !important;\r\n    white-space: inherit !important;\r\n}\r\n@media (max-width: 767px){\r\n.logo_banner {\r\n font-size: 23px !important;\r\n}\r\n}";s:15:"animation_class";s:3:"lfl";s:6:"easing";s:11:"easeOutBack";s:9:"endeasing";s:11:"easeOutBack";s:5:"speed";s:4:"2000";s:5:"start";s:3:"300";s:1:"x";s:3:"100";s:1:"y";s:3:"150";}}}}}');
...
-- 
-- Volcar la base de datos para la tabla `oc_upload`
-- 
...
-- 
-- Estructura de tabla para la tabla `oc_url_alias`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_url_alias`
-- 

INSERT INTO `oc_url_alias` VALUES (730, 'manufacturer_id=8', 'apple');
INSERT INTO `oc_url_alias` VALUES (772, 'information_id=4', 'about_us');
INSERT INTO `oc_url_alias` VALUES (861, 'product_id=57', '');
INSERT INTO `oc_url_alias` VALUES (854, 'category_id=62', '');
...
INSERT INTO `oc_url_alias` VALUES (849, 'information_id=8', '');
...
-- 
-- Volcar la base de datos para la tabla `oc_user`
-- 

INSERT INTO `oc_user` VALUES (1, 1, 'expigo', '725703d525e69d365139fe1fab35d8d855fcaae8', 'rrfCVYNJA', 'Sebastian', 'Gonzalez', 'yamil@skysite.com.ec', 'catalog/logoExpigo.jpg', '', '191.99.79.155', 1, '2016-06-07 16:30:32');
INSERT INTO `oc_user` VALUES (2, 1, 'mvillavi', 'fe3ac0dde5a65ee1ddfa2c7bb7d1c7cc24b830d1', 'aoNgV8FLJ', 'monica', 'villavicencio', 'jjbarrei@dvs.cco', '', '', '', 1, '2016-06-21 15:49:07');
INSERT INTO `oc_user` VALUES (3, 1, 'jjbarrei', 'aa9f17e07942abe512f60a1a4c4ffc41a28efcc9', '1d2MqqsBW', 'Jhon', 'Barreiro', 'jjbarrei@espol.edu.ec', '', '', '', 1, '2016-06-21 16:07:51');
...
-- 
-- Volcar la base de datos para la tabla `oc_voucher`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_voucher_history`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_voucher_theme`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_voucher_theme_description`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_weight_class`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_weight_class_description`
-- 
...
CREATE TABLE `oc_zone` (
  ...
  `status` tinyint(1) NOT NULL DEFAULT '1',
  PRIMARY KEY (`zone_id`)
) ENGINE=MyISAM AUTO_INCREMENT=4232 DEFAULT CHARSET=utf8 AUTO_INCREMENT=4232 ;

-- 
-- Volcar la base de datos para la tabla `oc_zone`
-- 
...
-- 
-- Volcar la base de datos para la tabla `oc_zone_to_geo_zone`
-- 
